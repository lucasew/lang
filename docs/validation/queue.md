...
| docs/faithful-port-checklist.md#3.A.1-UkrainianWordTokenizer | rejected | inspiration/languagetool/languagetool-language-modules/uk/src/main/java/org/languagetool/tokenizers/uk/UkrainianWordTokenizer.java; inspiration/languagetool/languagetool-language-modules/uk/src/test/java/org/languagetool/tokenizers/uk/UkrainianWordTokenizerTest.java | internal/languagetool/org/languagetool/tokenizers/uk/ | c24a2fc2ed1b5542b4207681e00024aaf5eacc41 | 1 | 0 | (1) LEADING_DASH BOS: Java charAt(0) on U+2013/U+2014; Go strings.ContainsRune(..., rune(text[0])) uses first byte 0xE2 so "–Виділено" stays one token. Fix: utf8 first-rune gate. (2) breakPlus: Java + only before Ukrainian letters/digits; Go also splits Latin (foo+bar). Fix: drop isLatinLetter from breakPlus. | | 2026-07-22T23:00:00Z |
