...
| Notes | ChineseWordTokenizer blocked (HanLP). UK CAP-revisit still eligible (K≥5). Remaining 3.A.1 leaf candidate: ChineseSentenceTokenizer (HanLP SentencesUtil — may also block). FR hybrid missing french.dict. |
