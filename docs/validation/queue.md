...
| docs/faithful-port-checklist.md#3.A.1-TagalogWordTokenizer | implementing | inspiration/languagetool/languagetool-language-modules/tl/src/main/java/org/languagetool/language/tokenizers/TagalogWordTokenizer.java | internal/languagetool/org/languagetool/tokenizers/tl/ | | 0 | 0 | | | 2026-07-23T04:09:12Z |
...
| Notes | After UK CAP: productive K=5 (ES, GoogleStyle, RU, DE, AR WordTokenizer ACCEPT @957a5824) — UK WordTokenizer CAP-revisit eligible next implement fire. FR hybrid still missing french.dict. |
