...
| Notes | GreekWordTokenizer ACCEPT @ d3e4cae3. UK CAP-revisit still eligible (K≥5). Remaining 3.A.1 leaves: Chinese WordTokenizer, ChineseSentence (HanLP deps); FR hybrid still missing french.dict. |
