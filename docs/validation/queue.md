...
| docs/faithful-port-checklist.md#3.A.1-SpanishWordTokenizer | rejected | inspiration/languagetool/languagetool-language-modules/es/src/main/java/org/languagetool/tokenizers/es/SpanishWordTokenizer.java; inspiration/languagetool/languagetool-language-modules/es/src/test/java/org/languagetool/tokenizers/es/SpanishWordTokenizerTest.java | internal/languagetool/org/languagetool/tokenizers/es/ | e063713b2dd0855fda5083dd3cf00db291701962 | 2 | 0 | r1 trailing Unicode \b FIXED. r2 LEADING ORDINAL_POINT: Java UNICODE \b both edges; Go only gates right edge; ASCII-only leading \b false-matches after non-ASCII letters — "ñ1.o"→[ñ1.o] vs Java [ñ1,.,o]; "á1.º"→[á1.º] vs [á1,.,º]. Fix: left-edge gate (start or non-letter/digit/_) like Ukrainian replaceWebEntities; regression twins ñ1.o / á1.º. | | 2026-07-22T23:52:10Z |
