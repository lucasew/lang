...
| docs/faithful-port-checklist.md#3.A.1-UkrainianWordTokenizer | implementing | inspiration/languagetool/languagetool-language-modules/uk/src/main/java/org/languagetool/tokenizers/uk/UkrainianWordTokenizer.java; inspiration/languagetool/languagetool-language-modules/uk/src/test/java/org/languagetool/tokenizers/uk/UkrainianWordTokenizerTest.java | internal/languagetool/org/languagetool/tokenizers/uk/ | 78f807472aa3a75532a0e3a3d904de0ad08fe996 | 1 | 1 | r1 REJECT: (1) NUMBER_MISSING_SPACE invent consume $|[^letter] vs Java (?!letter) → до14а wrong; (2) WEB_ENTITIES incomplete Unicode case vs Java CASE_INSENSITIVE (ІНФО/НеТ/ОРГ); (3) ABBR_DOT_2_SMALL invent freestanding мк ban; (4) protectSpacedNumbers incomplete Java [\h] (EN SPACE U+2002). | | 2026-07-23T02:21:36Z |
...
| docs/faithful-port-checklist.md#3.A.1-SpanishWordTokenizer | blocked | inspiration/languagetool/languagetool-language-modules/es/src/main/java/org/languagetool/tokenizers/es/SpanishWordTokenizer.java; inspiration/languagetool/languagetool-language-modules/es/src/test/java/org/languagetool/tokenizers/es/SpanishWordTokenizerTest.java | internal/languagetool/org/languagetool/tokenizers/es/ | e69a0d0174f149dea9d10d91936422be687c3e22 | 3 | 0 | r1 trailing letter/digit/_ FIXED; r2 leading letter FIXED (ñ1.o/á1.º). r3 REJECT: ORDINAL_POINT gate incomplete vs Java UNICODE_CHARACTER_CLASS \w — Go letter/digit/_ only misses Mn/Me/Mc/Pc/Join_Control neighbors (1.o+U+0301, ZWJ, Pc, VS-16 over-protect); also UCC \d vs ASCII [\d] for "١.º". | reject CAP=3 hit @ e69a0d01; remaining full Java-UCC \w/\d ORDINAL_POINT; revisit after K=5 productive steps | 2026-07-23T00:04:10Z |
...
| Blocked lines | `3.A.5-fr-hybrid-disambig-testChunker` (missing french.dict); `3.A.1-UkrainianWordTokenizer` (reject CAP=3: invent `(?i)` on case-sensitive abbr patterns + mid-word emdash pre-split; prior LEADING_DASH/breakPlus/bare-в. fixed); `3.A.1-SpanishWordTokenizer` (reject CAP=3: ORDINAL_POINT incomplete Java UCC `\w`/ `\d` — Mn/Me/Mc/Pc/Join_Control + non-ASCII digits; prior trailing/leading letter gates fixed) |
| Notes | UK word + ES word revisit after K=5 productive accepts/ready elsewhere, or next calendar day |
