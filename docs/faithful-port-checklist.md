...
|---|----------------------|--------|--------|
| 3.A.1 | Tokenizers (word + sentence / SRX) | 1:1 with Java for supported langs | [ ] partial; EN EnglishWordTokenizer twin ACCEPT @ f7c09ec6 (sub-sector 3.A.1-EnglishWordTokenizer); UK N_DASH_SPACE; NL/BE/PL/CA/DE-compound length UTF-16 |
| 3.A.2 | Taggers (Morfologik / language-specific) | 1:1 readings | [ ] startPos + many word.length() gates UTF-16; EN EnglishTaggerTest myAssert twin ACCEPT @ aa8917ed (sub-sector 3.A.2-EnglishTagger-testTagger) |
...
| 3.A.6 | Chunker (`EnglishChunker` + filters) | Same BIO/filter as Java | [ ] EnglishChunkFilter twin ACCEPT @ 859b2393; OpenNLP EnglishChunker path still partial |
