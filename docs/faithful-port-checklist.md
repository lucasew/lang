...
| 3.A.3 | `MultiWordChunker` | Official multiwords only | [ ] EN hybrid multiword stage ACCEPT @ 33b26663; core MultiWordChunkerTest twin ACCEPT @ 3b4841a4 (sub-sector 3.A.3-MultiWordChunker-core-test); PL PolishDisambiguationRuleTest.testChunker MultiWordChunker twin ACCEPT @ 09002c2f (sub-sector 3.A.3-PolishMultiWordChunker-testChunker; official pl/multiwords.txt); SV SwedishDisambiguationRuleTest.testChunker MultiWordChunker twin ACCEPT @ 0bf23c5c (sub-sector 3.A.3-SwedishMultiWordChunker-testChunker; official sv/multiwords.txt); GL MultiWordChunker official multiwords outcome twin ACCEPT @ f7e45200 (sub-sector 3.A.3-GalicianMultiWordChunker-testChunker; official gl/multiwords.txt); RU MultiWordChunker official multiwords outcome twin ACCEPT @ 0335a117 (sub-sector 3.A.3-RussianMultiWordChunker-testChunker; official ru/multiwords.txt); DE MultitokenIgnore isIgnoredBySpeller twin ACCEPT @ 64f5ab61 (sub-sector 3.A.3-GermanMultitokenIgnore-testChunker; official de/multitoken-ignore.txt; tagForNotAddingTags+/E/S/N); DE MultitokenGlobal isIgnoredBySpeller twin ACCEPT @ d7174cde (sub-sector 3.A.3-GermanMultitokenGlobal-spellingGlobal; official spelling_global.txt; allowFirstCap=false; ignoreSpelling); DE MultitokenSuggest isIgnoredBySpeller twin ACCEPT @ bdc0a3bb (sub-sector 3.A.3-GermanMultitokenSuggest-multitokenSuggest; official de/multitoken-suggest.txt; allowFirstCap=true; ignoreSpelling; /S); NL MultiWordChunker isIgnoredBySpeller twin ACCEPT @ f39caa9f (sub-sector 3.A.3-DutchMultiWordChunker-multiwords; official nl/multiwords.txt; tagForNotAddingTags+ignoreSpelling); NL GlobalChunker isIgnoredBySpeller twin ACCEPT @ da868816 (sub-sector 3.A.3-DutchGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=false; ignoreSpelling); ES MultiWordChunker open-close POS twin ACCEPT @ 218f5c07 (sub-sector 3.A.3-SpanishMultiWordChunker-multiwords; official es/multiwords.txt; allowFirstCap=true; removePreviousTags; no ignoreSpelling); ES GlobalChunker NPCN000 twin ACCEPT @ b980a2d8 (sub-sector 3.A.3-SpanishGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=false; DefaultTag NPCN000; no ignoreSpelling); PT MultiWordChunker POS+ignore twin ACCEPT @ d31c3e98 (sub-sector 3.A.3-PortugueseMultiWordChunker-multiwords; official pt/multiwords.txt; allowFirstCap=true; allowTitlecase=true; removePreviousTags+ignoreSpelling); PT GlobalChunker NPCN000+ignore twin ACCEPT @ 629dba41 (sub-sector 3.A.3-PortugueseGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=false; allowTitlecase=true; DefaultTag NPCN000; ignoreSpelling); CA MultiWordChunker open-close POS twin ACCEPT @ 276de50f (sub-sector 3.A.3-CatalanMultiWordChunker-multiwords; official ca/multiwords.txt; allowFirstCap=true; removePreviousTags; no ignoreSpelling); CA GlobalChunker NPCN000 twin ACCEPT @ 870d5ac4 (sub-sector 3.A.3-CatalanGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=false; DefaultTag NPCN000; no ignoreSpelling); FR MultiWordChunker N→J/Z POS twin ACCEPT @ 6c793521 (sub-sector 3.A.3-FrenchMultiWordChunker-multiwords; official fr/multiwords.txt; allowFirstCap=true; removePreviousTags; no ignoreSpelling); FR GlobalChunker tagForNotAddingTags+ignore twin ACCEPT @ d661f8ff (sub-sector 3.A.3-FrenchGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=false; tagForNotAddingTags; ignoreSpelling) ; GA MultiWordChunker open-close POS twin ACCEPT @ d74e3c6a (sub-sector 3.A.3-IrishMultiWordChunker-multiwords; official ga/multiwords.txt; defaults F/F/F; no ignoreSpelling); UK UkrainianMultiwordChunker MultiWordChunker2 twin ACCEPT @ 5178649a (sub-sector 3.A.3-UkrainianMultiwordChunker-multiwords; official uk/multiwords.txt; allowFirstCap=true; /POS-regex MatchesFn); EN MultiWordChunker ignore+removePrevious twin ACCEPT @ 33b26663 (sub-sector 3.A.3-EnglishMultiWordChunker-multiwords; official en/multiwords.txt; allowFirstCap=true; allowAllUpper=true; ignoreSpelling+removePreviousTags); EN GlobalChunker tagForNotAddingTags+ignore twin ACCEPT @ c95da659 (sub-sector 3.A.3-EnglishGlobalChunker-spellingGlobal; official spelling_global.txt; allowFirstCap=true; allowAllUpper=true; tagForNotAddingTags; ignoreSpelling)|
| 3.A.4 | `XmlRuleDisambiguator` | Full lang XML + global when Java enables | [ ] EN hybrid wires official XML+global; loader has rulegroup/`and`/`marker`; RO RomanianRuleDisambiguatorTest myAssert twin ACCEPT @ 5cccbe9d (sub-sector 3.A.4-RomanianRuleDisambiguator-tests; official ro/disambiguation.xml; useGlobal=false); IT ItalianRuleDisambiguator myAssert twin ACCEPT @ 358cef6a (sub-sector 3.A.4-ItalianRuleDisambiguator-tests; official it/disambiguation.xml; useGlobal=false; unifier |= multi-reading); AR XmlRuleDisambiguator myAssert twin ACCEPT @ 2a2854e5 (sub-sector 3.A.4-ArabicXmlRuleDisambiguator-tests; official ar/disambiguation.xml; useGlobal=false); DA XmlRuleDisambiguator myAssert twin ACCEPT @ bb04780c (sub-sector 3.A.4-DanishXmlRuleDisambiguator-tests; official da/disambiguation.xml; useGlobal=false); RU XmlRuleDisambiguator myAssert twin ACCEPT @ 237276ea (sub-sector 3.A.4-RussianXmlRuleDisambiguator-tests; official ru/disambiguation.xml; useGlobal=false); PL XmlRuleDisambiguator myAssert twin ACCEPT @ be2281e7 (sub-sector 3.A.4-PolishXmlRuleDisambiguator-tests; official pl/disambiguation.xml; useGlobal=false; XML-then-multiword hybrid); GL XmlRuleDisambiguator myAssert twin ACCEPT @ e211113b (sub-sector 3.A.4-GalicianXmlRuleDisambiguator-tests; official gl/disambiguation.xml; useGlobal=false; multiword-then-XML hybrid); BR XmlRuleDisambiguator myAssert twin ACCEPT @ 7ee07bf6 (sub-sector 3.A.4-BretonXmlRuleDisambiguator-tests; official br/disambiguation.xml; useGlobal=false; pure XmlRule; REPLACE lemma empty-only); EO XmlRuleDisambiguator myAssert twin ACCEPT @ 6ef9d062 (sub-sector 3.A.4-EsperantoXmlRuleDisambiguator-tests; official eo/disambiguation.xml; useGlobal=false; pure XmlRule; 7/7 rules); KM XmlRuleDisambiguator myAssert twin ACCEPT @ 440afa41 (sub-sector 3.A.4-KhmerXmlRuleDisambiguator-tests; official km/disambiguation.xml; useGlobal=false; pure XmlRule; ~25/28 rules); SV XmlRuleDisambiguator immunize/ignore_spelling twin ACCEPT @ 8b4125db (sub-sector 3.A.4-SwedishXmlRuleDisambiguator-tests; official sv/disambiguation.xml; useGlobal=false; hybrid Rules wire; 32/32 rules); SR XmlRuleDisambiguator ignore_spelling twin ACCEPT @ 10741059 (sub-sector 3.A.4-SerbianXmlRuleDisambiguator-tests; official sr/disambiguation.xml; useGlobal=false; hybrid Rules wire; RIMSKI_BROJEVI 1/1); DE XmlRuleDisambiguator ignore_spelling twin ACCEPT @ c8f93edb (sub-sector 3.A.4-GermanXmlRuleDisambiguator-tests; official de/disambiguation.xml+disambiguation-global.xml; useGlobal=true; GermanRuleDisambiguator Rules wire; 874+65 rules); NL XmlRuleDisambiguator ignore_spelling twin ACCEPT @ 7451a6b9 (sub-sector 3.A.4-DutchXmlRuleDisambiguator-tests; official nl/disambiguation.xml+disambiguation-global.xml; useGlobal=true; hybrid Rules wire); ES XmlRuleDisambiguator ignore_spelling twin ACCEPT @ 59e24751 (sub-sector 3.A.4-SpanishXmlRuleDisambiguator-tests; official es/disambiguation.xml+disambiguation-global.xml; useGlobal=true; hybrid Rules wire); PT XmlRuleDisambiguator ignore_spelling twin ACCEPT @ 860ef038 (sub-sector 3.A.4-PortugueseXmlRuleDisambiguator-tests; official pt/disambiguation.xml+disambiguation-global.xml; useGlobal=true; hybrid Rules wire); CA XmlRuleDisambiguator ignore_spelling twin ACCEPT @ 1375b506 (sub-sector 3.A.4-CatalanXmlRuleDisambiguator-tests; official ca/disambiguation.xml+disambiguation-global.xml; useGlobal=true; hybrid Rules wire) ; FR XmlRuleDisambiguator ignore_spelling twin ACCEPT @ ce09e739 (sub-sector 3.A.4-FrenchXmlRuleDisambiguator-tests; official fr/disambiguation.xml+disambiguation-global.xml; useGlobal=true); GA XmlRuleDisambiguator text-only twin ACCEPT @ 68457a67 (sub-sector 3.A.4-IrishXmlRuleDisambiguator-tests; official ga/disambiguation.xml; useGlobal=false; hybrid Rules wire); UK XmlRuleDisambiguator outcome twin ACCEPT @ d45f80ce (sub-sector 3.A.4-UkrainianXmlRuleDisambiguator-tests; official uk/disambiguation.xml; useGlobal=false; hybrid Rules wire); EL Greek XmlRuleDisambiguator HAVE_INF twin ACCEPT @ 62163db9 (sub-sector 3.A.4-GreekXmlRuleDisambiguator-tests; official el/disambiguation.xml; useGlobal=false; pure XmlRule); EN XmlRuleDisambiguator hybrid outcome twin ACCEPT @ 6066967c (sub-sector 3.A.4-EnglishXmlRuleDisambiguator-tests; official en/disambiguation.xml+disambiguation-global.xml; useGlobal=true; hybrid Rules wire)|
| 3.A.5 | Hybrid disambiguators (EN/FR/DE/NL/PT/CA/ES/…) | Same order as Java hybrids | [ ] EN/FR/ES/PT/DE/CA/NL wired; EN testChunker myAssert twin ACCEPT @ 251a9820 (sub-sector 3.A.5-en-hybrid-disambig-testChunker); ES SpanishHybrid stage-order twin ACCEPT @ 5a7dbc0f (sub-sector 3.A.5-es-hybrid-disambig-order; global→multiword→XML; removePreviousTags; no ignoreSpelling on chunkers); PT PortugueseHybrid stage-order twin ACCEPT @ c7e4330f (sub-sector 3.A.5-pt-hybrid-disambig-order; global→multiword→XML; ignoreSpelling both chunkers; titlecase/allowAllUpper; removePreviousTags); NL DutchHybrid stage-order twin ACCEPT @ f45458b6 (sub-sector 3.A.5-nl-hybrid-disambig-order; global→multiword→XML; tagForNotAddingTags; ignoreSpelling both; no removePreviousTags); FR FrenchHybrid stage-order twin ACCEPT @ 1e6bba1f (sub-sector 3.A.5-fr-hybrid-disambig-order; global→multiword→XML; tagForNotAddingTags+ignore on global; removePreviousTags multiword; no french.dict); DE GermanRuleDisambiguator stage-order twin ACCEPT @ 8e042e3f (sub-sector 3.A.5-de-hybrid-disambig-order; ignore→global→suggest→XML; tagForNotAddingTags+ignoreSpelling on all three chunkers); CA CatalanHybrid stage-order twin ACCEPT @ 5f2663b3 (sub-sector 3.A.5-ca-hybrid-disambig-order; global→multiword→XML→Multitoken; NPCN000 global; removePreviousTags multiword; Multitoken nil IsMisspelled no-op); EN EnglishHybrid stage-order twin ACCEPT @ 83906d2f (sub-sector 3.A.5-en-hybrid-disambig-order; global→multiword→XML; tagForNotAddingTags+ignore on both chunkers; removePreviousTags multiword; allowFirstCap both); PL PolishHybrid stage-order twin ACCEPT @ 695bb2f7 (sub-sector 3.A.5-pl-hybrid-disambig-order; XML→multiword inverted vs Romance; F,F,F multiword; useGlobal=false); RU RussianHybrid stage-order twin ACCEPT @ bff0b87e (sub-sector 3.A.5-ru-hybrid-disambig-order; multiword→XML; F,F,F multiword; useGlobal=false); SV SwedishHybrid stage-order twin ACCEPT @ 7e8c0673 (sub-sector 3.A.5-sv-hybrid-disambig-order; XML→multiword inverted; F,F,F multiword; useGlobal=false); GL GalicianHybrid stage-order twin ACCEPT @ f12e60c8 (sub-sector 3.A.5-gl-hybrid-disambig-order; multiword→XML; F,F,F multiword; useGlobal=false); GA IrishHybrid stage-order twin ACCEPT @ 8f161a59 (sub-sector 3.A.5-ga-hybrid-disambig-order; multiword→XML; F,F,F multiword; useGlobal=false); AR ArabicHybrid stage-order twin ACCEPT @ 7e04c5a5 (sub-sector 3.A.5-ar-hybrid-disambig-order; multiword→XML; F,F,F empty official multiwords wired; useGlobal=false); SR SerbianHybrid stage-order twin ACCEPT @ cff608fd (sub-sector 3.A.5-sr-hybrid-disambig-order; multiword→XML; F,F,F empty official multiwords wired; useGlobal=false); UK UkrainianHybrid stage-order twin ACCEPT @ 68242bd3 (sub-sector 3.A.5-uk-hybrid-disambig-order; pre→multiword→XML; allowFirstCap multiword; useGlobal=false) |
| 3.A.6 | Chunker (`EnglishChunker` + filters) | Same BIO/filter as Java | [ ] partial; EN EnglishChunkFilter twin ACCEPT @ 859b2393; EN EnglishChunker OpenNLP twin ACCEPT @ a59fd76b (sub-sector 3.A.6-EnglishChunker); DE GermanChunker rule-based NP twin ACCEPT @ 59298ec4 (sub-sector 3.A.6-GermanChunker; REGEXES1→REGEXES2; full/basic assertChunks; TokenPredicate); RU RussianChunker rule-based twin ACCEPT @ 332c0dbb (sub-sector 3.A.6-RussianChunker; REGEXES1→REGEXES2 behavior matrix; no Java test class); other-lang chunkers remain |
