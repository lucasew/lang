...
func TestGolden_SoftIdiomConfusablesWave151(t *testing.T) {
	cases := []struct {
		...
		{"Run a queyr carefully.", "EN_SOFT_QUERY_MISS", "query"},
		{"Send a reponse carefully.", "EN_SOFT_RESPONSE_MISS2", "response"},
		{"Handle the requset carefully.", "EN_SOFT_REQUEST_MISS", "request"},
		{"Check the reuslt carefully.", "EN_SOFT_RESULT_MISS", "result"},
		{"Please reutrn carefully.", "EN_SOFT_RETURN_MISS", "return"},
		{"Run the scirpt carefully.", "EN_SOFT_SCRIPT_MISS", "script"},
		{"Please seelct carefully.", "EN_SOFT_SELECT_MISS", "select"},
		{"Please serach carefully.", "EN_SOFT_SEARCH_MISS", "search"},
		{"Start the serivce carefully.", "EN_SOFT_SERVICE_MISS", "service"},
		{"Restart the sevrer carefully.", "EN_SOFT_SERVER_MISS", "server"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave127(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Estimate tam carefully.", "EN_SOFT_PICKY_TAM"},
		{"Compute ltv carefully.", "EN_SOFT_PICKY_LTV"},
		{"Lower cac carefully.", "EN_SOFT_PICKY_CAC"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeHazelcastScyllaCockroachdb(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Cache with hazelcast carefully.",
		"Cache with Hazelcast carefully.",
		"Store in scylla carefully.",
		"Store in Scylla carefully.",
		"Run cockroachdb carefully.",
		"Run CockroachDB carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave152(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"You shoudl try carefully.", "EN_SOFT_SHOULD_MISS", "should"},
		{"Keep it simpel carefully.", "EN_SOFT_SIMPLE_MISS", "simple"},
		{"Take soem time carefully.", "EN_SOFT_SOME_MISS", "some"},
		{"Find soemthing carefully.", "EN_SOFT_SOMETHING_MISS3", "something"},
		{"Check the soruce carefully.", "EN_SOFT_SOURCE_MISS", "source"},
		{"Be more specifc carefully.", "EN_SOFT_SPECIFIC_MISS", "specific"},
		{"Check the stauts carefully.", "EN_SOFT_STATUS_MISS", "status"},
		{"Pass a stirng carefully.", "EN_SOFT_STRING_MISS", "string"},
		{"Offer suport carefully.", "EN_SOFT_SUPPORT_MISS", "support"},
		{"Fix the sytem carefully.", "EN_SOFT_SYSTEM_MISS", "system"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave128(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Report gmv carefully.", "EN_SOFT_PICKY_GMV"},
		{"Track aov carefully.", "EN_SOFT_PICKY_AOV"},
		{"Measure roas carefully.", "EN_SOFT_PICKY_ROAS"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeYugabyteTidbVitess(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Store in yugabyte carefully.",
		"Store in Yugabyte carefully.",
		"Run tidb carefully.",
		"Run TiDB carefully.",
		"Shard with vitess carefully.",
		"Shard with Vitess carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave153(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Create a tabel carefully.", "EN_SOFT_TABLE_MISS", "table"},
		{"Edit the tempalte carefully.", "EN_SOFT_TEMPLATE_MISS", "template"},
		{"Use thsi value carefully.", "EN_SOFT_THIS_MISS", "this"},
		{"Save tiem carefully.", "EN_SOFT_TIME_MISS", "time"},
		{"Pick a tpye carefully.", "EN_SOFT_TYPE_MISS", "type"},
		{"Please udpate carefully.", "EN_SOFT_UPDATE_MISS", "update"},
		{"Create a uesr carefully.", "EN_SOFT_USER_MISS", "user"},
		{"Keep it unqiue carefully.", "EN_SOFT_UNIQUE_MISS", "unique"},
		{"Mark as vaild carefully.", "EN_SOFT_VALID_MISS", "valid"},
		{"Set a varaible carefully.", "EN_SOFT_VARIABLE_MISS", "variable"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave129(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track mau carefully.", "EN_SOFT_PICKY_MAU"},
		{"Track dau carefully.", "EN_SOFT_PICKY_DAU"},
		{"Compute arpu carefully.", "EN_SOFT_PICKY_ARPU"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeNatsMeilisearchTypesense(t *testing.T) {
	...
	for _, text := range []string{
		...
		"Publish on NATS carefully.",
		"Index with meilisearch carefully.",
		"Index with Meilisearch carefully.",
		"Search with typesense carefully.",
		"Search with Typesense carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave154(t *testing.T) {
	cases := []struct {
		...
		{"Open the veiw carefully.", "EN_SOFT_VIEW_MISS", "view"},
		{"Set a vlaue carefully.", "EN_SOFT_VALUE_MISS", "value"},
		{"Ask wehre carefully.", "EN_SOFT_WHERE_MISS", "where"},
		{"Choose whcih carefully.", "EN_SOFT_WHICH_MISS", "which"},
		{"Please wiat carefully.", "EN_SOFT_WAIT_MISS", "wait"},
		{"Start the wokr carefully.", "EN_SOFT_WORK_MISS", "work"},
		{"I told yuo carefully.", "EN_SOFT_YOU_MISS", "you"},
		{"Check yuor notes carefully.", "EN_SOFT_YOUR_MISS", "your"},
		{"Cats adn dogs carefully.", "EN_SOFT_AND_MISS", "and"},
		{"Cats nad dogs carefully.", "EN_SOFT_AND_MISS2", "and"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave130(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track wau carefully.", "EN_SOFT_PICKY_WAU"},
		{"Report nrr carefully.", "EN_SOFT_PICKY_NRR"},
		{"Report grr carefully.", "EN_SOFT_PICKY_GRR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeCassandraMongodbElasticsearch(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Store in cassandra carefully.",
		"Store in Cassandra carefully.",
...
func TestGolden_SoftIdiomConfusablesWave155(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"I woudl try carefully.", "EN_SOFT_WOULD_MISS", "would"},
		{"I coudl help carefully.", "EN_SOFT_COULD_MISS", "could"},
		{"You shoud try carefully.", "EN_SOFT_SHOULD_MISS2", "should"},
		{"Check the configration carefully.", "EN_SOFT_CONFIGURATION_MISS", "configuration"},
		{"Enable authentification carefully.", "EN_SOFT_AUTHENTICATION_MISS", "authentication"},
		{"Keep it runing carefully.", "EN_SOFT_RUNNING_MISS", "running"},
		{"Avoid stoping carefully.", "EN_SOFT_STOPPING_MISS", "stopping"},
		{"Keep geting better carefully.", "EN_SOFT_GETTING_MISS", "getting"},
		{"Keep makeing progress carefully.", "EN_SOFT_MAKING_MISS", "making"},
		{"Keep takeing notes carefully.", "EN_SOFT_TAKING_MISS", "taking"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave131(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Measure qps carefully.", "EN_SOFT_PICKY_QPS"},
		{"Measure rps carefully.", "EN_SOFT_PICKY_RPS"},
		{"Define an sli carefully.", "EN_SOFT_PICKY_SLI"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeNeo4jDgraphJanusgraph(t *testing.T) {
	...
	for _, text := range []string{
		...
		"Store in Neo4j carefully.",
		"Query dgraph carefully.",
		"Query Dgraph carefully.",
		"Run janusgraph carefully.",
		"Run JanusGraph carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave156(t *testing.T) {
	cases := []struct {
		...
		{"Keep haveing fun carefully.", "EN_SOFT_HAVING_MISS", "having"},
		{"Keep giveing help carefully.", "EN_SOFT_GIVING_MISS", "giving"},
		{"Keep goeing forward carefully.", "EN_SOFT_GOING_MISS", "going"},
		{"Keep doeing work carefully.", "EN_SOFT_DOING_MISS", "doing"},
		{"Keep knoweing more carefully.", "EN_SOFT_KNOWING_MISS", "knowing"},
		{"Keep thinkeing hard carefully.", "EN_SOFT_THINKING_MISS", "thinking"},
		{"Keep sayeing yes carefully.", "EN_SOFT_SAYING_MISS", "saying"},
		{"Keep seeeing more carefully.", "EN_SOFT_SEEING_MISS", "seeing"},
		{"Keep comeing back carefully.", "EN_SOFT_COMING_MISS2", "coming"},
		{"Keep leaveing early carefully.", "EN_SOFT_LEAVING_MISS", "leaving"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave132(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track mttr carefully.", "EN_SOFT_PICKY_MTTR"},
		{"Track mtbf carefully.", "EN_SOFT_PICKY_MTBF"},
		{"Set an rto carefully.", "EN_SOFT_PICKY_RTO"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeSolrCosmosdbFirestore(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Index with solr carefully.",
		"Index with Solr carefully.",
		"Store in cosmosdb carefully.",
		"Store in CosmosDB carefully.",
		"Store in firestore carefully.",
		"Store in Firestore carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave157(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Keep moveing forward carefully.", "EN_SOFT_MOVING_MISS", "moving"},
		{"Keep proveing it carefully.", "EN_SOFT_PROVING_MISS", "proving"},
		{"Keep driveing safely carefully.", "EN_SOFT_DRIVING_MISS", "driving"},
		{"Keep typeing fast carefully.", "EN_SOFT_TYPING_MISS", "typing"},
		{"Keep hopeing more carefully.", "EN_SOFT_HOPING_MISS", "hoping"},
		{"Keep careing well carefully.", "EN_SOFT_CARING_MISS", "caring"},
		{"Keep shareing more carefully.", "EN_SOFT_SHARING_MISS", "sharing"},
		{"Keep storeing data carefully.", "EN_SOFT_STORING_MISS", "storing"},
		{"Keep scoreing goals carefully.", "EN_SOFT_SCORING_MISS", "scoring"},
		{"Keep forceing updates carefully.", "EN_SOFT_FORCING_MISS", "forcing"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave133(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Set an rpo carefully.", "EN_SOFT_PICKY_RPO"},
		{"Configure ttl carefully.", "EN_SOFT_PICKY_TTL"},
		{"Measure tps carefully.", "EN_SOFT_PICKY_TPS"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeBigtableSpannerCouchbase(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Store in bigtable carefully.",
		"Store in Bigtable carefully.",
		"Run spanner carefully.",
		"Run Spanner carefully.",
		"Cache with couchbase carefully.",
		"Cache with Couchbase carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave158(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Keep changeing code carefully.", "EN_SOFT_CHANGING_MISS", "changing"},
		{"Keep manageing work carefully.", "EN_SOFT_MANAGING_MISS", "managing"},
		{"Keep engageing users carefully.", "EN_SOFT_ENGAGING_MISS", "engaging"},
		{"Keep arrangeing meetings carefully.", "EN_SOFT_ARRANGING_MISS", "arranging"},
		{"Track performace carefully.", "EN_SOFT_PERFORMANCE_MISS", "performance"},
		{"Track perfromance carefully.", "EN_SOFT_PERFORMANCE_MISS2", "performance"},
		{"Write a requriement carefully.", "EN_SOFT_REQUIREMENT_MISS", "requirement"},
		{"Write a requirment carefully.", "EN_SOFT_REQUIREMENT_MISS2", "requirement"},
		{"Read the specifcation carefully.", "EN_SOFT_SPECIFICATION_MISS", "specification"},
		{"Review the architecure carefully.", "EN_SOFT_ARCHITECTURE_MISS", "architecture"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave134(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Pull the andon carefully.", "EN_SOFT_PICKY_ANDON"},
		{"Track apdex carefully.", "EN_SOFT_PICKY_APDEX"},
		{"Reduce toil carefully.", "EN_SOFT_PICKY_TOIL"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeOpentelemetryCouchdbRethinkdb(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Instrument with opentelemetry carefully.",
		"Instrument with OpenTelemetry carefully.",
		"Store in couchdb carefully.",
		"Store in CouchDB carefully.",
		"Query rethinkdb carefully.",
		"Query RethinkDB carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave159(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Build the infrastrucure carefully.", "EN_SOFT_INFRASTRUCTURE_MISS", "infrastructure"},
		{"Open the dashbord carefully.", "EN_SOFT_DASHBOARD_MISS", "dashboard"},
		{"Open the dashbaord carefully.", "EN_SOFT_DASHBOARD_MISS2", "dashboard"},
		{"Send a notificaion carefully.", "EN_SOFT_NOTIFICATION_MISS", "notification"},
		{"Start a subscrition carefully.", "EN_SOFT_SUBSCRIPTION_MISS", "subscription"},
		{"Start a subcription carefully.", "EN_SOFT_SUBSCRIPTION_MISS2", "subscription"},
		{"Run validaton carefully.", "EN_SOFT_VALIDATION_MISS", "validation"},
		{"Enable encription carefully.", "EN_SOFT_ENCRYPTION_MISS", "encryption"},
		{"Enable compresion carefully.", "EN_SOFT_COMPRESSION_MISS", "compression"},
		{"Configure replicaton carefully.", "EN_SOFT_REPLICATION_MISS", "replication"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave135(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Write a postmortem carefully.", "EN_SOFT_PICKY_POSTMORTEM"},
		{"Follow the runbook carefully.", "EN_SOFT_PICKY_RUNBOOK"},
		{"Open the playbook carefully.", "EN_SOFT_PICKY_PLAYBOOK"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeSupabasePlanetscaleFauna(t *testing.T) {
	...
	for _, text := range []string{
		...
		"Store in Supabase carefully.",
		"Run planetscale carefully.",
		"Run PlanetScale carefully.",
		"Query fauna carefully.",
		"Query Fauna carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave160(t *testing.T) {
	cases := []struct {
		...
		{"Create a partiton carefully.", "EN_SOFT_PARTITION_MISS", "partition"},
		{"Enable throtling carefully.", "EN_SOFT_THROTTLING_MISS", "throttling"},
		{"Enable cacheing carefully.", "EN_SOFT_CACHING_MISS", "caching"},
		{"Start the brokker carefully.", "EN_SOFT_BROKER_MISS", "broker"},
		{"Start the consumr carefully.", "EN_SOFT_CONSUMER_MISS2", "consumer"},
		{"Start the producr carefully.", "EN_SOFT_PRODUCER_MISS", "producer"},
		{"Register a handlre carefully.", "EN_SOFT_HANDLER_MISS", "handler"},
		{"Add a controler carefully.", "EN_SOFT_CONTROLLER_MISS", "controller"},
		{"Add midleware carefully.", "EN_SOFT_MIDDLEWARE_MISS", "middleware"},
		{"Add middelware carefully.", "EN_SOFT_MIDDLEWARE_MISS2", "middleware"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave136(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Improve process capability carefully.", "EN_SOFT_PICKY_PROCESS_CAPABILITY"},
		{"Keep it blameless carefully.", "EN_SOFT_PICKY_BLAMELESS"},
		{"Join oncall carefully.", "EN_SOFT_PICKY_ONCALL"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeNeonTursoSurrealdb(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Store in neon carefully.",
		"Store in Neon carefully.",
		"Run turso carefully.",
		"Run Turso carefully.",
		"Query surrealdb carefully.",
		"Query SurrealDB carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave161(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Send the paylod carefully.", "EN_SOFT_PAYLOAD_MISS", "payload"},
		{"Click the buton carefully.", "EN_SOFT_BUTTON_MISS", "button"},
		{"Set a lable carefully.", "EN_SOFT_LABEL_MISS", "label"},
		{"Fill the placehlder carefully.", "EN_SOFT_PLACEHOLDER_MISS", "placeholder"},
		{"Open the dropdwn carefully.", "EN_SOFT_DROPDOWN_MISS", "dropdown"},
		{"Tick the chekbox carefully.", "EN_SOFT_CHECKBOX_MISS", "checkbox"},
		{"Fix the navigaton carefully.", "EN_SOFT_NAVIGATION_MISS", "navigation"},
		{"Open the direcoty carefully.", "EN_SOFT_DIRECTORY_MISS", "directory"},
		{"Choose a filenme carefully.", "EN_SOFT_FILENAME_MISS", "filename"},
		{"Pick a framwork carefully.", "EN_SOFT_FRAMEWORK_MISS", "framework"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave137(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Ship a canary carefully.", "EN_SOFT_PICKY_CANARY"},
		{"Plan a rollback carefully.", "EN_SOFT_PICKY_ROLLBACK"},
		{"Use blue green carefully.", "EN_SOFT_PICKY_BLUE_GREEN"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeEdgedbLibsqlTimescale(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Store in edgedb carefully.",
		"Store in EdgeDB carefully.",
		"Run libsql carefully.",
		"Run LibSQL carefully.",
		"Query timescale carefully.",
		"Query Timescale carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave162(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Pick a framewrok carefully.", "EN_SOFT_FRAMEWORK_MISS2", "framework"},
		{"Build a componet carefully.", "EN_SOFT_COMPONENT_MISS", "component"},
		{"Build a compnent carefully.", "EN_SOFT_COMPONENT_MISS2", "component"},
		{"Add a utilty carefully.", "EN_SOFT_UTILITY_MISS", "utility"},
		{"Allocate a reource carefully.", "EN_SOFT_RESOURCE_MISS2", "resource"},
		{"Define a modle carefully.", "EN_SOFT_MODEL_MISS", "model"},
		{"Update the scheam carefully.", "EN_SOFT_SCHEMA_MISS", "schema"},
		{"Run a migraiton carefully.", "EN_SOFT_MIGRATION_MISS", "migration"},
		{"Ship a featre carefully.", "EN_SOFT_FEATURE_MISS2", "feature"},
		{"Cut a relese carefully.", "EN_SOFT_RELEASE_MISS", "release"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave138(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Run a shadow carefully.", "EN_SOFT_PICKY_SHADOW"},
		{"Run a soak test carefully.", "EN_SOFT_PICKY_SOAK_TEST"},
		{"Add a feature toggle carefully.", "EN_SOFT_PICKY_FEATURE_TOGGLE"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeDrizzleTypeormSequelize(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Query with drizzle carefully.",
		"Query with Drizzle carefully.",
		"Map with typeorm carefully.",
		"Map with TypeORM carefully.",
		"Map with sequelize carefully.",
		"Map with Sequelize carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave163(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Bump the versin carefully.", "EN_SOFT_VERSION_MISS3", "version"},
		{"Set the headeer carefully.", "EN_SOFT_HEADER_MISS", "header"},
		{"Set the footre carefully.", "EN_SOFT_FOOTER_MISS", "footer"},
		{"Open the sidebaar carefully.", "EN_SOFT_SIDEBAR_MISS", "sidebar"},
		{"Open the toolbaar carefully.", "EN_SOFT_TOOLBAR_MISS", "toolbar"},
		{"Open the navbaar carefully.", "EN_SOFT_NAVBAR_MISS", "navbar"},
		{"Show a toolitp carefully.", "EN_SOFT_TOOLTIP_MISS", "tooltip"},
		{"Show a toottip carefully.", "EN_SOFT_TOOLTIP_MISS2", "tooltip"},
		{"Add a textaree carefully.", "EN_SOFT_TEXTAREA_MISS", "textarea"},
		{"Add a textaera carefully.", "EN_SOFT_TEXTAREA_MISS2", "textarea"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave139(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Wait for bake time carefully.", "EN_SOFT_PICKY_BAKE_TIME"},
		{"Enable synthetic monitoring carefully.", "EN_SOFT_PICKY_SYNTHETIC_MONITORING"},
		{"Use ring deployment carefully.", "EN_SOFT_PICKY_RING_DEPLOYMENT"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeHasuraPostgrestKnex(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Query with hasura carefully.",
		"Query with Hasura carefully.",
		"Serve with postgrest carefully.",
		"Serve with PostgREST carefully.",
		"Query with knex carefully.",
		"Query with Knex carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave164(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Fix the scrolbar carefully.", "EN_SOFT_SCROLLBAR_MISS", "scrollbar"},
		{"Add paginaton carefully.", "EN_SOFT_PAGINATION_MISS", "pagination"},
		{"Add pagiantion carefully.", "EN_SOFT_PAGINATION_MISS2", "pagination"},
		{"Create a namespc carefully.", "EN_SOFT_NAMESPACE_MISS", "namespace"},
		{"Create a namesace carefully.", "EN_SOFT_NAMESPACE_MISS2", "namespace"},
		{"Install a plugn carefully.", "EN_SOFT_PLUGIN_MISS", "plugin"},
		{"Install a plugni carefully.", "EN_SOFT_PLUGIN_MISS2", "plugin"},
		{"Load an extensoin carefully.", "EN_SOFT_EXTENSION_MISS2", "extension"},
		{"Write a helpr carefully.", "EN_SOFT_HELPER_MISS", "helper"},
		{"Map an enttiy carefully.", "EN_SOFT_ENTITY_MISS", "entity"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave140(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Plan traffic shifting carefully.", "EN_SOFT_PICKY_TRAFFIC_SHIFTING"},
		{"Enable autoscaling carefully.", "EN_SOFT_PICKY_AUTOSCALING"},
		{"Practice finops carefully.", "EN_SOFT_PICKY_FINOPS"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeMikroormWaterlineTypegoose(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Map with mikroorm carefully.",
		"Map with MikroORM carefully.",
		"Map with waterline carefully.",
		"Map with Waterline carefully.",
		"Map with typegoose carefully.",
		"Map with Typegoose carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave165(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Map an entiy carefully.", "EN_SOFT_ENTITY_MISS2", "entity"},
		{"Load a fixtre carefully.", "EN_SOFT_FIXTURE_MISS", "fixture"},
		{"Write an asserion carefully.", "EN_SOFT_ASSERTION_MISS", "assertion"},
		{"Write an asserton carefully.", "EN_SOFT_ASSERTION_MISS2", "assertion"},
		{"Cover a scneario carefully.", "EN_SOFT_SCENARIO_MISS", "scenario"},
		{"Cover a scenaro carefully.", "EN_SOFT_SCENARIO_MISS2", "scenario"},
		{"Ship a bugifx carefully.", "EN_SOFT_BUGFIX_MISS", "bugfix"},
		{"Ship a hotifx carefully.", "EN_SOFT_HOTFIX_MISS", "hotfix"},
		{"Ship a hotfx carefully.", "EN_SOFT_HOTFIX_MISS2", "hotfix"},
		{"Cut a relaese carefully.", "EN_SOFT_RELEASE_MISS2", "release"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave141(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Start rightsizing carefully.", "EN_SOFT_PICKY_RIGHTSIZING"},
		{"Publish showback carefully.", "EN_SOFT_PICKY_SHOWBACK"},
		{"Apply chargeback carefully.", "EN_SOFT_PICKY_CHARGEBACK"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeKyselySlonikZapatos(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Query with kysely carefully.",
		"Query with Kysely carefully.",
		"Query with slonik carefully.",
		"Query with Slonik carefully.",
		"Query with zapatos carefully.",
		"Query with Zapatos carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave166(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Bump the vesion carefully.", "EN_SOFT_VERSION_MISS4", "version"},
		{"Update the changlog carefully.", "EN_SOFT_CHANGELOG_MISS", "changelog"},
		{"Update the changelg carefully.", "EN_SOFT_CHANGELOG_MISS2", "changelog"},
		{"Edit the reademe carefully.", "EN_SOFT_README_MISS", "readme"},
		{"Check the licene carefully.", "EN_SOFT_LICENSE_MISS4", "license"},
		{"Respect the copyrght carefully.", "EN_SOFT_COPYRIGHT_MISS2", "copyright"},
		{"Respect the copyrigth carefully.", "EN_SOFT_COPYRIGHT_MISS3", "copyright"},
		{"Register a tradeark carefully.", "EN_SOFT_TRADEMARK_MISS", "trademark"},
		{"Register a trademak carefully.", "EN_SOFT_TRADEMARK_MISS2", "trademark"},
		{"Check compatability carefully.", "EN_SOFT_COMPATIBILITY_MISS", "compatibility"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave142(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Buy spot instances carefully.", "EN_SOFT_PICKY_SPOT_INSTANCES"},
		{"Buy reserved instances carefully.", "EN_SOFT_PICKY_RESERVED_INSTANCES"},
		{"Choose a savings plan carefully.", "EN_SOFT_PICKY_SAVINGS_PLAN"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeMongoosePostgraphileGrafbase(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Map with mongoose carefully.",
		"Map with Mongoose carefully.",
		"Serve with postgraphile carefully.",
		"Serve with PostGraphile carefully.",
		"Deploy with grafbase carefully.",
		"Deploy with Grafbase carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave167(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Improve scalabilty carefully.", "EN_SOFT_SCALABILITY_MISS", "scalability"},
		{"Improve reliabilty carefully.", "EN_SOFT_RELIABILITY_MISS", "reliability"},
		{"Improve availabilty carefully.", "EN_SOFT_AVAILABILITY_MISS3", "availability"},
		{"Improve observabilty carefully.", "EN_SOFT_OBSERVABILITY_MISS", "observability"},
		{"Plan the deployement carefully.", "EN_SOFT_DEPLOYMENT_MISS", "deployment"},
		{"Check the configuraiton carefully.", "EN_SOFT_CONFIGURATION_MISS2", "configuration"},
		{"Improve orchestraton carefully.", "EN_SOFT_ORCHESTRATION_MISS", "orchestration"},
		{"Add instrumentaton carefully.", "EN_SOFT_INSTRUMENTATION_MISS", "instrumentation"},
		{"Fix serializaton carefully.", "EN_SOFT_SERIALIZATION_MISS", "serialization"},
		{"Fix deserializaton carefully.", "EN_SOFT_DESERIALIZATION_MISS", "deserialization"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave143(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track unit economics carefully.", "EN_SOFT_PICKY_UNIT_ECONOMICS"},
		{"Lower the burn rate carefully.", "EN_SOFT_PICKY_BURN_RATE"},
		{"Improve gross margin carefully.", "EN_SOFT_PICKY_GROSS_MARGIN"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizePgtypedPgpromiseTrpc(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Query with pgtyped carefully.",
		"Query with PgTyped carefully.",
		"Query with pgpromise carefully.",
		"Query with pg-promise carefully.",
		"Call with trpc carefully.",
		"Call with tRPC carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave168(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Enable decompresion carefully.", "EN_SOFT_DECOMPRESSION_MISS", "decompression"},
		{"Enable authenticaiton carefully.", "EN_SOFT_AUTHENTICATION_MISS2", "authentication"},
		{"Enable authorizaion carefully.", "EN_SOFT_AUTHORIZATION_MISS", "authorization"},
		{"Grant permisson carefully.", "EN_SOFT_PERMISSION_MISS", "permission"},
		{"Clone the repositoriy carefully.", "EN_SOFT_REPOSITORY_MISS", "repository"},
		{"Clone the reposotory carefully.", "EN_SOFT_REPOSITORY_MISS2", "repository"},
		{"Deploy a microservicee carefully.", "EN_SOFT_MICROSERVICE_MISS", "microservice"},
		{"Deploy a microservce carefully.", "EN_SOFT_MICROSERVICE_MISS2", "microservice"},
		{"Install kubernets carefully.", "EN_SOFT_KUBERNETES_MISS", "kubernetes"},
		{"Install kuberentes carefully.", "EN_SOFT_KUBERNETES_MISS2", "kubernetes"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave144(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track cogs carefully.", "EN_SOFT_PICKY_COGS"},
		{"Meet the rule of 40 carefully.", "EN_SOFT_PICKY_RULE_OF_40"},
		{"Improve net dollar retention carefully.", "EN_SOFT_PICKY_NET_DOLLAR_RETENTION"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeUrqlSwrTanstack(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Fetch with urql carefully.",
		"Fetch with URQL carefully.",
		"Fetch with swr carefully.",
		"Fetch with SWR carefully.",
		"Fetch with tanstack carefully.",
		"Fetch with TanStack carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave169(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Edit the dockerfilee carefully.", "EN_SOFT_DOCKERFILE_MISS", "dockerfile"},
		{"Edit the dockerfle carefully.", "EN_SOFT_DOCKERFILE_MISS2", "dockerfile"},
		{"Build a pipelne carefully.", "EN_SOFT_PIPELINE_MISS", "pipeline"},
		{"Improve monitoreing carefully.", "EN_SOFT_MONITORING_MISS", "monitoring"},
		{"Collect telemety carefully.", "EN_SOFT_TELEMETRY_MISS", "telemetry"},
		{"Configure alertting carefully.", "EN_SOFT_ALERTING_MISS", "alerting"},
		{"Send a notifcation carefully.", "EN_SOFT_NOTIFICATION_MISS2", "notification"},
		{"Start a subscribtion carefully.", "EN_SOFT_SUBSCRIPTION_MISS3", "subscription"},
		{"Complete registraton carefully.", "EN_SOFT_REGISTRATION_MISS", "registration"},
		{"Run validaiton carefully.", "EN_SOFT_VALIDATION_MISS2", "validation"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave145(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track the quick ratio carefully.", "EN_SOFT_PICKY_QUICK_RATIO"},
		{"Shorten the payback period carefully.", "EN_SOFT_PICKY_PAYBACK_PERIOD"},
		{"Improve contribution margin carefully.", "EN_SOFT_PICKY_CONTRIBUTION_MARGIN"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeZodValibotTypebox(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Validate with zod carefully.",
		"Validate with Zod carefully.",
		"Validate with valibot carefully.",
		"Validate with Valibot carefully.",
		"Validate with typebox carefully.",
		"Validate with TypeBox carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave170(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Enable encrypion carefully.", "EN_SOFT_ENCRYPTION_MISS2", "encryption"},
		{"Enable decrypion carefully.", "EN_SOFT_DECRYPTION_MISS", "decryption"},
		{"Enable throtteling carefully.", "EN_SOFT_THROTTLING_MISS2", "throttling"},
		{"Configure the loadbalancor carefully.", "EN_SOFT_LOADBALANCER_MISS", "loadbalancer"},
		{"Configure the loadballancer carefully.", "EN_SOFT_LOADBALANCER_MISS2", "loadbalancer"},
		{"Add a healthchek carefully.", "EN_SOFT_HEALTHCHECK_MISS", "healthcheck"},
		{"Add a healthchekc carefully.", "EN_SOFT_HEALTHCHECK_MISS2", "healthcheck"},
		{"Check readynes carefully.", "EN_SOFT_READINESS_MISS", "readiness"},
		{"Check livenes carefully.", "EN_SOFT_LIVENESS_MISS", "liveness"},
		{"Run a sidecr carefully.", "EN_SOFT_SIDECAR_MISS", "sidecar"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave146(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Lower the churn rate carefully.", "EN_SOFT_PICKY_CHURN_RATE"},
		{"Shorten cac payback carefully.", "EN_SOFT_PICKY_CAC_PAYBACK"},
		{"Track the magic number carefully.", "EN_SOFT_PICKY_MAGIC_NUMBER"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeArktypeSuperstructRuntypes(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Validate with arktype carefully.",
		"Validate with ArkType carefully.",
		"Validate with superstruct carefully.",
		"Validate with Superstruct carefully.",
		"Validate with runtypes carefully.",
		"Validate with Runtypes carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave171(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Configure the ingresss carefully.", "EN_SOFT_INGRESS_MISS", "ingress"},
		{"Configure egres carefully.", "EN_SOFT_EGRESS_MISS", "egress"},
		{"Create a namespcae carefully.", "EN_SOFT_NAMESPACE_MISS3", "namespace"},
		{"Apply a rolebindng carefully.", "EN_SOFT_ROLEBINDING_MISS", "rolebinding"},
		{"Apply a networkpolic carefully.", "EN_SOFT_NETWORKPOLICY_MISS", "networkpolicy"},
		{"Deploy a statefullset carefully.", "EN_SOFT_STATEFULSET_MISS", "statefulset"},
		{"Deploy a deamonset carefully.", "EN_SOFT_DAEMONSET_MISS", "daemonset"},
		{"Schedule a cronjobb carefully.", "EN_SOFT_CRONJOB_MISS", "cronjob"},
		{"Start a jobqueuee carefully.", "EN_SOFT_JOBQUEUE_MISS", "jobqueue"},
		{"Start a workqueuee carefully.", "EN_SOFT_WORKQUEUE_MISS", "workqueue"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave147(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Grow expansion revenue carefully.", "EN_SOFT_PICKY_EXPANSION_REVENUE"},
		{"Limit contraction revenue carefully.", "EN_SOFT_PICKY_CONTRACTION_REVENUE"},
		{"Improve net revenue retention carefully.", "EN_SOFT_PICKY_NET_REVENUE_RETENTION"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeYupJoiClassvalidator(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Validate with yup carefully.",
		"Validate with Yup carefully.",
		"Validate with joi carefully.",
		"Validate with Joi carefully.",
		"Validate with classvalidator carefully.",
		"Validate with class-validator carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
			_, err := CoreGoldenHook(&buf, text, &CommandLineOptions{Language: "en"})
...
func TestGolden_SoftIdiomConfusablesWave172(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Publish on the eventbuss carefully.", "EN_SOFT_EVENTBUS_MISS", "eventbus"},
		{"Publish on the messagebuss carefully.", "EN_SOFT_MESSAGEBUS_MISS", "messagebus"},
		{"Assign a topicpartiton carefully.", "EN_SOFT_TOPICPARTITION_MISS", "topicpartition"},
		{"Join a consumergrop carefully.", "EN_SOFT_CONSUMERGROUP_MISS", "consumergroup"},
		{"Join a producergrop carefully.", "EN_SOFT_PRODUCERGROUP_MISS", "producergroup"},
		{"Add a circuitbraker carefully.", "EN_SOFT_CIRCUITBREAKER_MISS", "circuitbreaker"},
		{"Add a bulkheadd carefully.", "EN_SOFT_BULKHEAD_MISS", "bulkhead"},
		{"Configure retrypolic carefully.", "EN_SOFT_RETRYPOLICY_MISS", "retrypolicy"},
		{"Configure timeoutpolic carefully.", "EN_SOFT_TIMEOUTPOLICY_MISS", "timeoutpolicy"},
		{"Configure retrybackof carefully.", "EN_SOFT_RETRYBACKOFF_MISS", "retrybackoff"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave148(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Reduce logo churn carefully.", "EN_SOFT_PICKY_LOGO_CHURN"},
		{"Reduce revenue churn carefully.", "EN_SOFT_PICKY_REVENUE_CHURN"},
		{"Drive seat expansion carefully.", "EN_SOFT_PICKY_SEAT_EXPANSION"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeNestjsFastifyHono(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Build with nestjs carefully.",
		"Build with NestJS carefully.",
		"Serve with fastify carefully.",
		"Serve with Fastify carefully.",
		"Serve with hono carefully.",
		"Serve with Hono carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave173(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Enable horizonal scaling carefully.", "EN_SOFT_HORIZONTAL_MISS", "horizontal"},
		{"Enable verticalscalng carefully.", "EN_SOFT_VERTICALSCALING_MISS", "verticalscaling"},
		{"Enable horizontalscalng carefully.", "EN_SOFT_HORIZONTALSCALING_MISS", "horizontalscaling"},
		{"Configure a deadletterq carefully.", "EN_SOFT_DEADLETTERQUEUE_MISS", "deadletterqueue"},
		{"Add an initcontainr carefully.", "EN_SOFT_INITCONTAINER_MISS", "initcontainer"},
		{"Create a configmapp carefully.", "EN_SOFT_CONFIGMAP_MISS", "configmap"},
		{"Create a secretstoree carefully.", "EN_SOFT_SECRETSTORE_MISS", "secretstore"},
		{"Set a poddisrupton carefully.", "EN_SOFT_PODDISRUPTION_MISS", "poddisruption"},
		{"Mount a persistenvolume carefully.", "EN_SOFT_PERSISTENTVOLUME_MISS", "persistentvolume"},
		{"Pick a storageclas carefully.", "EN_SOFT_STORAGECLASS_MISS", "storageclass"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave149(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track gross revenue retention carefully.", "EN_SOFT_PICKY_GROSS_REVENUE_RETENTION"},
		{"Improve ltv cac carefully.", "EN_SOFT_PICKY_LTV_CAC"},
		{"Shorten payback months carefully.", "EN_SOFT_PICKY_PAYBACK_MONTHS"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeElysiaSveltekitAstro(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Build with elysia carefully.",
		"Build with Elysia carefully.",
		"Build with sveltekit carefully.",
		"Build with SvelteKit carefully.",
		"Build with astro carefully.",
		"Build with Astro carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave174(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Pick an ingressclas carefully.", "EN_SOFT_INGRESSCLASS_MISS", "ingressclass"},
		{"Pick a gatewayclas carefully.", "EN_SOFT_GATEWAYCLASS_MISS", "gatewayclass"},
		{"Create an httproutee carefully.", "EN_SOFT_HTTPROUTE_MISS", "httproute"},
		{"Create a tcproutee carefully.", "EN_SOFT_TCPROUTE_MISS", "tcproute"},
		{"Create a grpcroutee carefully.", "EN_SOFT_GRPCROUTE_MISS", "grpcroute"},
		{"Apply a referencgrant carefully.", "EN_SOFT_REFERENCEGRANT_MISS", "referencegrant"},
		{"Handle backpresure carefully.", "EN_SOFT_BACKPRESSURE_MISS", "backpressure"},
		{"Enable ratelimitting carefully.", "EN_SOFT_RATELIMITING_MISS", "ratelimiting"},
		{"Use a semaphoree carefully.", "EN_SOFT_SEMAPHORE_MISS", "semaphore"},
		{"Use a tokenbuket carefully.", "EN_SOFT_TOKENBUCKET_MISS", "tokenbucket"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave150(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track arr growth carefully.", "EN_SOFT_PICKY_ARR_GROWTH"},
		{"Track mrr growth carefully.", "EN_SOFT_PICKY_MRR_GROWTH"},
		{"Recognize deferred revenue carefully.", "EN_SOFT_PICKY_DEFERRED_REVENUE"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeRemixNuxtQwik(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Build with remix carefully.",
		"Build with Remix carefully.",
		"Build with nuxt carefully.",
		"Build with Nuxt carefully.",
		"Build with qwik carefully.",
		"Build with Qwik carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave175(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Use a leakybuket carefully.", "EN_SOFT_LEAKYBUCKET_MISS", "leakybucket"},
		{"Use exponetialbackoff carefully.", "EN_SOFT_EXPONENTIALBACKOFF_MISS", "exponentialbackoff"},
		{"Prefer failfastt carefully.", "EN_SOFT_FAILFAST_MISS", "failfast"},
		{"Prefer failsoftt carefully.", "EN_SOFT_FAILSOFT_MISS", "failsoft"},
		{"Enable gracefuldegradaton carefully.", "EN_SOFT_GRACEFULDEGRADATION_MISS", "gracefuldegradation"},
		{"Enable jitteredrettry carefully.", "EN_SOFT_JITTEREDRETRY_MISS", "jitteredretry"},
		{"Use fulljitterr carefully.", "EN_SOFT_FULLJITTER_MISS", "fulljitter"},
		{"Enter halfopenstatee carefully.", "EN_SOFT_HALFOPENSTATE_MISS", "halfopenstate"},
		{"Enter openstatee carefully.", "EN_SOFT_OPENSTATE_MISS", "openstate"},
		{"Enter closedstatee carefully.", "EN_SOFT_CLOSEDSTATE_MISS", "closedstate"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave151(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Measure pipeline coverage carefully.", "EN_SOFT_PICKY_PIPELINE_COVERAGE"},
		{"Improve win rate carefully.", "EN_SOFT_PICKY_WIN_RATE"},
		{"Track deferred bookings carefully.", "EN_SOFT_PICKY_DEFERRED_BOOKINGS"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeGatsbySolidstartTurbopack(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Build with gatsby carefully.",
		"Build with Gatsby carefully.",
		"Build with solidstart carefully.",
		"Build with SolidStart carefully.",
		"Build with turbopack carefully.",
		"Build with Turbopack carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave176(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set connecttimeoutt carefully.", "EN_SOFT_CONNECTIONTIMEOUT_MISS", "connectiontimeout"},
		{"Set readtimeoutt carefully.", "EN_SOFT_READTIMEOUT_MISS", "readtimeout"},
		{"Set writetimeoutt carefully.", "EN_SOFT_WRITETIMEOUT_MISS", "writetimeout"},
		{"Set idletimeoutt carefully.", "EN_SOFT_IDLETIMEOUT_MISS", "idletimeout"},
		{"Set keepalivetimeoutt carefully.", "EN_SOFT_KEEPALIVETIMEOUT_MISS", "keepalivetimeout"},
		{"Limit maxconnectionss carefully.", "EN_SOFT_MAXCONNECTIONS_MISS", "maxconnections"},
		{"Limit maxretriess carefully.", "EN_SOFT_MAXRETRIES_MISS", "maxretries"},
		{"Set minbackoffk carefully.", "EN_SOFT_MINBACKOFF_MISS", "minbackoff"},
		{"Set maxbackoffk carefully.", "EN_SOFT_MAXBACKOFF_MISS", "maxbackoff"},
		{"Limit retryattempss carefully.", "EN_SOFT_RETRYATTEMPTS_MISS", "retryattempts"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave152(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track acv carefully.", "EN_SOFT_PICKY_ACV"},
		{"Track tcv carefully.", "EN_SOFT_PICKY_TCV"},
		{"Track asp carefully.", "EN_SOFT_PICKY_ASP"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeRollupEsbuildRspack(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Bundle with rollup carefully.",
		"Bundle with Rollup carefully.",
		"Bundle with esbuild carefully.",
		"Bundle with Esbuild carefully.",
		"Bundle with rspack carefully.",
		"Bundle with Rspack carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave177(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Handle circuitopenerr carefully.", "EN_SOFT_CIRCUITOPEN_MISS", "circuitopen"},
		{"Inspect breakerstatee carefully.", "EN_SOFT_BREAKERSTATE_MISS", "breakerstate"},
		{"Configure sleepwindoww carefully.", "EN_SOFT_SLEEPWINDOW_MISS", "sleepwindow"},
		{"Enable hystrixx carefully.", "EN_SOFT_HYSTRIX_MISS", "hystrix"},
		{"Improve resiliencyy carefully.", "EN_SOFT_RESILIENCY_MISS", "resiliency"},
		{"Improve resiliencee carefully.", "EN_SOFT_RESILIENCE_MISS", "resilience"},
		{"Improve faulttoleranc carefully.", "EN_SOFT_FAULTTOLERANCE_MISS", "faulttolerance"},
		{"Enable selfhealling carefully.", "EN_SOFT_SELFHEALING_MISS", "selfhealing"},
		{"Enable autohealng carefully.", "EN_SOFT_AUTOHEALING_MISS", "autohealing"},
		{"Expose healthendpont carefully.", "EN_SOFT_HEALTHENDPOINT_MISS", "healthendpoint"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave153(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Report bookings carefully.", "EN_SOFT_PICKY_BOOKINGS"},
		{"Report billings carefully.", "EN_SOFT_PICKY_BILLINGS"},
		{"Track quota attainment carefully.", "EN_SOFT_PICKY_QUOTA_ATTAINMENT"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeParcelSwcBiome(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Bundle with parcel carefully.",
		"Bundle with Parcel carefully.",
		"Compile with swc carefully.",
		"Compile with SWC carefully.",
		"Lint with biome carefully.",
		"Lint with Biome carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave178(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Expose metricsendpont carefully.", "EN_SOFT_METRICSENDPOINT_MISS", "metricsendpoint"},
		{"Expose readyzendpont carefully.", "EN_SOFT_READYZENDPOINT_MISS", "readyzendpoint"},
		{"Expose livezendpont carefully.", "EN_SOFT_LIVEZENDPOINT_MISS", "livezendpoint"},
		{"Set successThreshhold carefully.", "EN_SOFT_SUCCESSTHRESHOLD_MISS", "successthreshold"},
		{"Set failThreshhold carefully.", "EN_SOFT_FAILURETHRESHOLD_MISS", "failurethreshold"},
		{"Set requestvolumethresh carefully.", "EN_SOFT_REQUESTVOLUMETHRESHOLD_MISS", "requestvolumethreshold"},
		{"Set errorpercentthresh carefully.", "EN_SOFT_ERRORPERCENTAGETHRESHOLD_MISS", "errorpercentagethreshold"},
		{"Assign commandkeyy carefully.", "EN_SOFT_COMMANDKEY_MISS", "commandkey"},
		{"Assign threadpoolkeyy carefully.", "EN_SOFT_THREADPOOLKEY_MISS", "threadpoolkey"},
		{"Assign collapserkeyy carefully.", "EN_SOFT_COLLAPSERKEY_MISS", "collapserkey"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave154(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track committed arr carefully.", "EN_SOFT_PICKY_COMMITTED_ARR"},
		{"Track ending arr carefully.", "EN_SOFT_PICKY_ENDING_ARR"},
		{"Track beginning arr carefully.", "EN_SOFT_PICKY_BEGINNING_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeOxcUnocssPostcss(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Lint with oxc carefully.",
		"Lint with Oxc carefully.",
		"Style with unocss carefully.",
		"Style with UnoCSS carefully.",
		"Transform with postcss carefully.",
		"Transform with PostCSS carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave179(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set traceparentt carefully.", "EN_SOFT_TRACEPARENT_MISS", "traceparent"},
		{"Set tracestatee carefully.", "EN_SOFT_TRACESTATE_MISS", "tracestate"},
		{"Log spanidd carefully.", "EN_SOFT_SPANID_MISS", "spanid"},
		{"Log traceidd carefully.", "EN_SOFT_TRACEID_MISS", "traceid"},
		{"Propagate baggagee carefully.", "EN_SOFT_BAGGAGE_MISS", "baggage"},
		{"Configure sampleratee carefully.", "EN_SOFT_SAMPLERATE_MISS", "samplerate"},
		{"Record an exemplarr carefully.", "EN_SOFT_EXEMPLAR_MISS", "exemplar"},
		{"Export a histogramm carefully.", "EN_SOFT_HISTOGRAM_MISS", "histogram"},
		{"Export a summaryy carefully.", "EN_SOFT_SUMMARY_MISS", "summary"},
		{"Increment a counterr carefully.", "EN_SOFT_COUNTER_MISS", "counter"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave155(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track expansion arr carefully.", "EN_SOFT_PICKY_EXPANSION_ARR"},
		{"Track churned arr carefully.", "EN_SOFT_PICKY_CHURNED_ARR"},
		{"Track net new arr carefully.", "EN_SOFT_PICKY_NET_NEW_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeStylexStitchesLightningcss(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with stylex carefully.",
		"Style with StyleX carefully.",
		"Style with stitches carefully.",
		"Style with Stitches carefully.",
		"Bundle with lightningcss carefully.",
		"Bundle with LightningCSS carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave180(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set gaugge carefully.", "EN_SOFT_GAUGGE_MISS", "gauge"},
		{"Set updowncounterr carefully.", "EN_SOFT_UPDOWNCOUNTER_MISS", "updowncounter"},
		{"Configure batchprocessorr carefully.", "EN_SOFT_BATCHPROCESSOR_MISS", "batchprocessor"},
		{"Configure simpleprocessorr carefully.", "EN_SOFT_SIMPLEPROCESSOR_MISS", "simpleprocessor"},
		{"Set exporttimeoutt carefully.", "EN_SOFT_EXPORTTIMEOUT_MISS", "exporttimeout"},
		{"Use otlpendpont carefully.", "EN_SOFT_OTLPENDPOINT_MISS", "otlpendpoint"},
		{"Use jaegerendpont carefully.", "EN_SOFT_JAEGERENDPOINT_MISS", "jaegerendpoint"},
		{"Use zipkinendpont carefully.", "EN_SOFT_ZIPKINENDPOINT_MISS", "zipkinendpoint"},
		{"Export observablegaugge carefully.", "EN_SOFT_OBSERVABLEGAUGE_MISS", "observablegauge"},
		{"Set exportintervall carefully.", "EN_SOFT_EXPORTINTERVAL_MISS", "exportinterval"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave156(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track reactivated arr carefully.", "EN_SOFT_PICKY_REACTIVATED_ARR"},
		{"Track contraction arr carefully.", "EN_SOFT_PICKY_CONTRACTION_ARR"},
		{"Track gross new arr carefully.", "EN_SOFT_PICKY_GROSS_NEW_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeVanillaextractLinariaPandaGriffel(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with vanillaextract carefully.",
		"Style with VanillaExtract carefully.",
		"Style with linaria carefully.",
		"Style with Linaria carefully.",
		"Style with panda carefully.",
		"Style with Panda carefully.",
		"Style with griffel carefully.",
		"Style with Griffel carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave181(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set resourcedetectorr carefully.", "EN_SOFT_RESOURCEDETECTOR_MISS", "resourcedetector"},
		{"Configure spanprocessorr carefully.", "EN_SOFT_SPANPROCESSOR_MISS", "spanprocessor"},
		{"Configure batchspanprocessorr carefully.", "EN_SOFT_BATCHSPANPROCESSOR_MISS", "batchspanprocessor"},
		{"Configure simplespanprocessorr carefully.", "EN_SOFT_SIMPLESPANPROCESSOR_MISS", "simplespanprocessor"},
		{"Set metricreaderr carefully.", "EN_SOFT_METRICREADER_MISS", "metricreader"},
		{"Set periodicreaderr carefully.", "EN_SOFT_PERIODICREADER_MISS", "periodicreader"},
		{"Set manualreaderr carefully.", "EN_SOFT_MANUALREADER_MISS", "manualreader"},
		{"Set instrumentationscopee carefully.", "EN_SOFT_INSTRUMENTATIONSCOPE_MISS", "instrumentationscope"},
		{"Set serviceinstanceidd carefully.", "EN_SOFT_SERVICEINSTANCEID_MISS", "serviceinstanceid"},
		{"Call forceflushh carefully.", "EN_SOFT_FORCEFLUSH_MISS", "forceflush"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave157(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track renewal arr carefully.", "EN_SOFT_PICKY_RENEWAL_ARR"},
		{"Track deferred arr carefully.", "EN_SOFT_PICKY_DEFERRED_ARR"},
		{"Track run rate arr carefully.", "EN_SOFT_PICKY_RUN_RATE_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeGooberTamaguiNativewind(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with goober carefully.",
		"Style with Goober carefully.",
		"Style with tamagui carefully.",
		"Style with Tamagui carefully.",
		"Style with nativewind carefully.",
		"Style with NativeWind carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave182(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set b3propagatorr carefully.", "EN_SOFT_B3PROPAGATOR_MISS", "b3propagator"},
		{"Set w3cpropagatorr carefully.", "EN_SOFT_W3CPROPAGATOR_MISS", "w3cpropagator"},
		{"Set jaegerpropagatorr carefully.", "EN_SOFT_JAEGERPROPAGATOR_MISS", "jaegerpropagator"},
		{"Configure otlpexporterr carefully.", "EN_SOFT_OTLPEXPORTER_MISS", "otlpexporter"},
		{"Configure consoleexporterr carefully.", "EN_SOFT_CONSOLEEXPORTER_MISS", "consoleexporter"},
		{"Configure prometheusexporterr carefully.", "EN_SOFT_PROMETHEUSEXPORTER_MISS", "prometheusexporter"},
		{"Configure inmemoryexporterr carefully.", "EN_SOFT_INMEMORYEXPORTER_MISS", "inmemoryexporter"},
		{"Set maxexportbatchsizee carefully.", "EN_SOFT_MAXEXPORTBATCHSIZE_MISS", "maxexportbatchsize"},
		{"Set maxqueuesizee carefully.", "EN_SOFT_MAXQUEUESIZE_MISS", "maxqueuesize"},
		{"Set scheduledelayy carefully.", "EN_SOFT_SCHEDULEDELAY_MISS", "scheduledelay"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave158(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track recurring arr carefully.", "EN_SOFT_PICKY_RECURRING_ARR"},
		{"Track billed arr carefully.", "EN_SOFT_PICKY_BILLED_ARR"},
		{"Track booked arr carefully.", "EN_SOFT_PICKY_BOOKED_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeStyletronAstroturfWindicss(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with styletron carefully.",
		"Style with Styletron carefully.",
		"Style with astroturf carefully.",
		"Style with Astroturf carefully.",
		"Style with windicss carefully.",
		"Style with WindiCSS carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave183(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set tracecontextt carefully.", "EN_SOFT_TRACECONTEXT_MISS", "tracecontext"},
		{"Set viewconfigg carefully.", "EN_SOFT_VIEWCONFIG_MISS", "viewconfig"},
		{"Set spanlinkss carefully.", "EN_SOFT_SPANLINKS_MISS", "spanlinks"},
		{"Set spankindd carefully.", "EN_SOFT_SPANKIND_MISS", "spankind"},
		{"Set spanstatuss carefully.", "EN_SOFT_SPANSTATUS_MISS", "spanstatus"},
		{"Set eventnamess carefully.", "EN_SOFT_EVENTNAMES_MISS", "eventnames"},
		{"Set attributekeyss carefully.", "EN_SOFT_ATTRIBUTEKEYS_MISS", "attributekeys"},
		{"Set resourceattributess carefully.", "EN_SOFT_RESOURCEATTRIBUTES_MISS", "resourceattributes"},
		{"Set samplerresultt carefully.", "EN_SOFT_SAMPLERRESULT_MISS", "samplerresult"},
		{"Set parentbasedd carefully.", "EN_SOFT_PARENTBASED_MISS", "parentbased"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave159(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track recognized arr carefully.", "EN_SOFT_PICKY_RECOGNIZED_ARR"},
		{"Track pipelined arr carefully.", "EN_SOFT_PICKY_PIPELINED_ARR"},
		{"Track footprint arr carefully.", "EN_SOFT_PICKY_FOOTPRINT_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeAphroditeFelaCssmodules(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with aphrodite carefully.",
		"Style with Aphrodite carefully.",
		"Style with fela carefully.",
		"Style with Fela carefully.",
		"Style with cssmodules carefully.",
		"Style with CSSModules carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave184(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set alwaysonn carefully.", "EN_SOFT_ALWAYSON_MISS", "alwayson"},
		{"Set alwaysofff carefully.", "EN_SOFT_ALWAYSOFF_MISS", "alwaysoff"},
		{"Set traceidratioo carefully.", "EN_SOFT_TRACEIDRATIO_MISS", "traceidratio"},
		{"Set sampleratioo carefully.", "EN_SOFT_SAMPLERATIO_MISS", "sampleratio"},
		{"Set linkcontextt carefully.", "EN_SOFT_LINKCONTEXT_MISS", "linkcontext"},
		{"Set statusdescriptionn carefully.", "EN_SOFT_STATUSDESCRIPTION_MISS", "statusdescription"},
		{"Set exceptioneventt carefully.", "EN_SOFT_EXCEPTIONEVENT_MISS", "exceptionevent"},
		{"Set droppedattributess carefully.", "EN_SOFT_DROPPEDATTRIBUTES_MISS", "droppedattributes"},
		{"Set droppedeventss carefully.", "EN_SOFT_DROPPEDEVENTS_MISS", "droppedevents"},
		{"Set droppedlinkss carefully.", "EN_SOFT_DROPPEDLINKS_MISS", "droppedlinks"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave160(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track backlog arr carefully.", "EN_SOFT_PICKY_BACKLOG_ARR"},
		{"Track contracted arr carefully.", "EN_SOFT_PICKY_CONTRACTED_ARR"},
		{"Track retained arr carefully.", "EN_SOFT_PICKY_RETAINED_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeGlamorStyledcomponentsTwinmacro(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with glamor carefully.",
		"Style with Glamor carefully.",
		"Style with styledcomponents carefully.",
		"Style with StyledComponents carefully.",
		"Style with twinmacro carefully.",
		"Style with TwinMacro carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave185(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set starttimestampp carefully.", "EN_SOFT_STARTTIMESTAMP_MISS", "starttimestamp"},
		{"Set endtimestampp carefully.", "EN_SOFT_ENDTIMESTAMP_MISS", "endtimestamp"},
		{"Set spancontextt carefully.", "EN_SOFT_SPANCONTEXT_MISS", "spancontext"},
		{"Set tracestateheaderr carefully.", "EN_SOFT_TRACESTATEHEADER_MISS", "tracestateheader"},
		{"Set traceparentheaderr carefully.", "EN_SOFT_TRACEPARENTHEADER_MISS", "traceparentheader"},
		{"Set instrumentationlibraryy carefully.", "EN_SOFT_INSTRUMENTATIONLIBRARY_MISS", "instrumentationlibrary"},
		{"Configure meterproviderr carefully.", "EN_SOFT_METERPROVIDER_MISS", "meterprovider"},
		{"Configure tracerproviderr carefully.", "EN_SOFT_TRACERPROVIDER_MISS", "tracerprovider"},
		{"Configure loggerproviderr carefully.", "EN_SOFT_LOGGERPROVIDER_MISS", "loggerprovider"},
		{"Emit logrecordd carefully.", "EN_SOFT_LOGRECORD_MISS", "logrecord"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave161(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track pipeline arr carefully.", "EN_SOFT_PICKY_PIPELINE_ARR"},
		{"Track quota arr carefully.", "EN_SOFT_PICKY_QUOTA_ARR"},
		{"Track lost arr carefully.", "EN_SOFT_PICKY_LOST_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeCompiledcssStyle9Xstyled(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with compiledcss carefully.",
		"Style with CompiledCSS carefully.",
		"Style with style9 carefully.",
		"Style with Style9 carefully.",
		"Style with xstyled carefully.",
		"Style with XStyled carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave186(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set severitynumberr carefully.", "EN_SOFT_SEVERITYNUMBER_MISS", "severitynumber"},
		{"Set severitytextt carefully.", "EN_SOFT_SEVERITYTEXT_MISS", "severitytext"},
		{"Set bodyfieldd carefully.", "EN_SOFT_BODYFIELD_MISS", "bodyfield"},
		{"Set observedtimestampp carefully.", "EN_SOFT_OBSERVEDTIMESTAMP_MISS", "observedtimestamp"},
		{"Set logattributess carefully.", "EN_SOFT_LOGATTRIBUTES_MISS", "logattributes"},
		{"Set scopeattributess carefully.", "EN_SOFT_SCOPEATTRIBUTES_MISS", "scopeattributes"},
		{"Configure batchlogprocessorr carefully.", "EN_SOFT_BATCHLOGPROCESSOR_MISS", "batchlogprocessor"},
		{"Configure simplelogprocessorr carefully.", "EN_SOFT_SIMPLELOGPROCESSOR_MISS", "simplelogprocessor"},
		{"Configure otlplogexporterr carefully.", "EN_SOFT_OTLPLOGEXPORTER_MISS", "otlplogexporter"},
		{"Configure consolelogexporterr carefully.", "EN_SOFT_CONSOLELOGEXPORTER_MISS", "consolelogexporter"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave162(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track active arr carefully.", "EN_SOFT_PICKY_ACTIVE_ARR"},
		{"Track starting arr carefully.", "EN_SOFT_PICKY_STARTING_ARR"},
		{"Track closing arr carefully.", "EN_SOFT_PICKY_CLOSING_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeEmotioncssTreatcssRestyle(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with emotioncss carefully.",
		"Style with EmotionCSS carefully.",
		"Style with treatcss carefully.",
		"Style with TreatCSS carefully.",
		"Style with restyle carefully.",
		"Style with Restyle carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave187(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set logrecordlimitss carefully.", "EN_SOFT_LOGRECORDLIMITS_MISS", "logrecordlimits"},
		{"Set traceflagss carefully.", "EN_SOFT_TRACEFLAGS_MISS", "traceflags"},
		{"Set isremotee carefully.", "EN_SOFT_ISREMOTE_MISS", "isremote"},
		{"Set tracestatekeyy carefully.", "EN_SOFT_TRACESTATEKEY_MISS", "tracestatekey"},
		{"Set baggageentryy carefully.", "EN_SOFT_BAGGAGEENTRY_MISS", "baggageentry"},
		{"Set baggageheaderr carefully.", "EN_SOFT_BAGGAGEHEADER_MISS", "baggageheader"},
		{"Set contextkeyy carefully.", "EN_SOFT_CONTEXTKEY_MISS", "contextkey"},
		{"Set contextvaluee carefully.", "EN_SOFT_CONTEXTVALUE_MISS", "contextvalue"},
		{"Set spannamee carefully.", "EN_SOFT_SPANNAME_MISS", "spanname"},
		{"Call recordexceptionn carefully.", "EN_SOFT_RECORDEXCEPTION_MISS", "recordexception"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave163(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track total arr carefully.", "EN_SOFT_PICKY_TOTAL_ARR"},
		{"Track incremental arr carefully.", "EN_SOFT_PICKY_INCREMENTAL_ARR"},
		{"Track organic arr carefully.", "EN_SOFT_PICKY_ORGANIC_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeCsspropThemeuiRebass(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with cssprop carefully.",
		"Style with CSSProp carefully.",
		"Style with themeui carefully.",
		"Style with ThemeUI carefully.",
		"Style with rebass carefully.",
		"Style with Rebass carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave188(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Call addlinkk carefully.", "EN_SOFT_ADDLINK_MISS", "addlink"},
		{"Call addeventt carefully.", "EN_SOFT_ADDEVENT_MISS", "addevent"},
		{"Call setstatuss carefully.", "EN_SOFT_SETSTATUS_MISS", "setstatus"},
		{"Call setattributee carefully.", "EN_SOFT_SETATTRIBUTE_MISS", "setattribute"},
		{"Call getattributee carefully.", "EN_SOFT_GETATTRIBUTE_MISS", "getattribute"},
		{"Call updatenamee carefully.", "EN_SOFT_UPDATENAME_MISS", "updatename"},
		{"Check isrecordingg carefully.", "EN_SOFT_ISRECORDING_MISS", "isrecording"},
		{"Call endspann carefully.", "EN_SOFT_ENDSPAN_MISS", "endspan"},
		{"Call startspann carefully.", "EN_SOFT_STARTSPAN_MISS", "startspan"},
		{"Call withspann carefully.", "EN_SOFT_WITHSPAN_MISS", "withspan"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave164(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track inbound arr carefully.", "EN_SOFT_PICKY_INBOUND_ARR"},
		{"Track outbound arr carefully.", "EN_SOFT_PICKY_OUTBOUND_ARR"},
		{"Track upsell arr carefully.", "EN_SOFT_PICKY_UPSELL_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeChakraStyledsystemParkui(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with chakra carefully.",
		"Style with Chakra carefully.",
		"Style with styledsystem carefully.",
		"Style with StyledSystem carefully.",
		"Style with parkui carefully.",
		"Style with ParkUI carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave189(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set nonrecordingg carefully.", "EN_SOFT_NONRECORDING_MISS", "nonrecording"},
		{"Set recordingspann carefully.", "EN_SOFT_RECORDINGSPAN_MISS", "recordingspan"},
		{"Set noopspann carefully.", "EN_SOFT_NOOPSPAN_MISS", "noopspan"},
		{"Set proxyspann carefully.", "EN_SOFT_PROXYSPAN_MISS", "proxyspan"},
		{"Set serverspann carefully.", "EN_SOFT_SERVERSPAN_MISS", "serverspan"},
		{"Set clientspann carefully.", "EN_SOFT_CLIENTSPAN_MISS", "clientspan"},
		{"Set internalspann carefully.", "EN_SOFT_INTERNALSPAN_MISS", "internalspan"},
		{"Set producerspann carefully.", "EN_SOFT_PRODUCERSPAN_MISS", "producerspan"},
		{"Set consumerspann carefully.", "EN_SOFT_CONSUMERSPAN_MISS", "consumerspan"},
		{"Configure spanbuilderr carefully.", "EN_SOFT_SPANBUILDER_MISS", "spanbuilder"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave165(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track crosssell arr carefully.", "EN_SOFT_PICKY_CROSSSELL_ARR"},
		{"Track downsell arr carefully.", "EN_SOFT_PICKY_DOWNSELL_ARR"},
		{"Track partner arr carefully.", "EN_SOFT_PICKY_PARTNER_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeZagjsArkuiPandacss(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with zagjs carefully.",
		"Style with ZagJS carefully.",
		"Style with arkui carefully.",
		"Style with ArkUI carefully.",
		"Style with pandacss carefully.",
		"Style with PandaCSS carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave190(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Configure tracerbuilderr carefully.", "EN_SOFT_TRACERBUILDER_MISS", "tracerbuilder"},
		{"Configure meterbuilderr carefully.", "EN_SOFT_METERBUILDER_MISS", "meterbuilder"},
		{"Configure loggerbuilderr carefully.", "EN_SOFT_LOGGERBUILDER_MISS", "loggerbuilder"},
		{"Configure providerbuilderr carefully.", "EN_SOFT_PROVIDERBUILDER_MISS", "providerbuilder"},
		{"Configure samplerbuilderr carefully.", "EN_SOFT_SAMPLERBUILDER_MISS", "samplerbuilder"},
		{"Configure exporterbuilderr carefully.", "EN_SOFT_EXPORTERBUILDER_MISS", "exporterbuilder"},
		{"Configure processorbuilderr carefully.", "EN_SOFT_PROCESSORBUILDER_MISS", "processorbuilder"},
		{"Configure readerbuilderr carefully.", "EN_SOFT_READERBUILDER_MISS", "readerbuilder"},
		{"Configure viewbuilderr carefully.", "EN_SOFT_VIEWBUILDER_MISS", "viewbuilder"},
		{"Configure instrumentbuilderr carefully.", "EN_SOFT_INSTRUMENTBUILDER_MISS", "instrumentbuilder"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave166(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track channel arr carefully.", "EN_SOFT_PICKY_CHANNEL_ARR"},
		{"Track renewed arr carefully.", "EN_SOFT_PICKY_RENEWED_ARR"},
		{"Track canceled arr carefully.", "EN_SOFT_PICKY_CANCELED_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeMantineAntdHeadlessui(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with mantine carefully.",
		"Style with Mantine carefully.",
		"Style with antd carefully.",
		"Style with AntD carefully.",
		"Style with headlessui carefully.",
		"Style with HeadlessUI carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave191(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Configure counterbuilderr carefully.", "EN_SOFT_COUNTERBUILDER_MISS", "counterbuilder"},
		{"Configure histogrambuilderr carefully.", "EN_SOFT_HISTOGRAMBUILDER_MISS", "histogrambuilder"},
		{"Configure gaugebuilderr carefully.", "EN_SOFT_GAUGEBUILDER_MISS", "gaugebuilder"},
		{"Configure updowncounterbuilderr carefully.", "EN_SOFT_UPDOWNCOUNTERBUILDER_MISS", "updowncounterbuilder"},
		{"Configure observablecounterbuilderr carefully.", "EN_SOFT_OBSERVABLECOUNTERBUILDER_MISS", "observablecounterbuilder"},
		{"Configure observablegaugebuilderr carefully.", "EN_SOFT_OBSERVABLEGAUGEBUILDER_MISS", "observablegaugebuilder"},
		{"Set callbackregistrationn carefully.", "EN_SOFT_CALLBACKREGISTRATION_MISS", "callbackregistration"},
		{"Set asynchronousinstrumentt carefully.", "EN_SOFT_ASYNCHRONOUSINSTRUMENT_MISS", "asynchronousinstrument"},
		{"Set synchronousinstrumentt carefully.", "EN_SOFT_SYNCHRONOUSINSTRUMENT_MISS", "synchronousinstrument"},
		{"Set aggregationtemporalityy carefully.", "EN_SOFT_AGGREGATIONTEMPORALITY_MISS", "aggregationtemporality"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave167(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track gross arr carefully.", "EN_SOFT_PICKY_GROSS_ARR"},
		{"Track direct arr carefully.", "EN_SOFT_PICKY_DIRECT_ARR"},
		{"Track selfserve arr carefully.", "EN_SOFT_PICKY_SELFSERVE_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeRadixuiShadcnDaisyui(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with radixui carefully.",
		"Style with RadixUI carefully.",
		"Style with shadcn carefully.",
		"Style with Shadcn carefully.",
		"Style with daisyui carefully.",
		"Style with DaisyUI carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave192(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set deltatemporalityy carefully.", "EN_SOFT_DELTATEMPORALITY_MISS", "deltatemporality"},
		{"Set cumulativetemporalityy carefully.", "EN_SOFT_CUMULATIVETEMPORALITY_MISS", "cumulativetemporality"},
		{"Set explicitbucketboundaryy carefully.", "EN_SOFT_EXPLICITBUCKETBOUNDARY_MISS", "explicitbucketboundary"},
		{"Set exponentialhistogramm carefully.", "EN_SOFT_EXPONENTIALHISTOGRAM_MISS", "exponentialhistogram"},
		{"Set base2exponentialhistogramm carefully.", "EN_SOFT_BASE2EXPONENTIALHISTOGRAM_MISS", "base2exponentialhistogram"},
		{"Configure aggregationselectorr carefully.", "EN_SOFT_AGGREGATIONSELECTOR_MISS", "aggregationselector"},
		{"Configure temporalityselectorr carefully.", "EN_SOFT_TEMPORALITYSELECTOR_MISS", "temporalityselector"},
		{"Set defaultaggregationg carefully.", "EN_SOFT_DEFAULTAGGREGATION_MISS", "defaultaggregation"},
		{"Set dropaggregationn carefully.", "EN_SOFT_DROPAGGREGATION_MISS", "dropaggregation"},
		{"Set sumaggregationn carefully.", "EN_SOFT_SUMAGGREGATION_MISS", "sumaggregation"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave168(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track product arr carefully.", "EN_SOFT_PICKY_PRODUCT_ARR"},
		{"Track segment arr carefully.", "EN_SOFT_PICKY_SEGMENT_ARR"},
		{"Track cohort arr carefully.", "EN_SOFT_PICKY_COHORT_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeFlowbitePrelineNextui(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with flowbite carefully.",
		"Style with Flowbite carefully.",
		"Style with preline carefully.",
		"Style with Preline carefully.",
		"Style with nextui carefully.",
		"Style with NextUI carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave193(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Set lastvalueaggregationn carefully.", "EN_SOFT_LASTVALUEAGGREGATION_MISS", "lastvalueaggregation"},
		{"Set explicitbucketaggregationn carefully.", "EN_SOFT_EXPLICITBUCKETAGGREGATION_MISS", "explicitbucketaggregation"},
		{"Configure metricproducerr carefully.", "EN_SOFT_METRICPRODUCER_MISS", "metricproducer"},
		{"Configure periodicmetricreaderr carefully.", "EN_SOFT_PERIODICMETRICREADER_MISS", "periodicmetricreader"},
		{"Configure manualmetricreaderr carefully.", "EN_SOFT_MANUALMETRICREADER_MISS", "manualmetricreader"},
		{"Configure collectormetricreaderr carefully.", "EN_SOFT_COLLECTORMETRICREADER_MISS", "collectormetricreader"},
		{"Configure pushmetricexportterr carefully.", "EN_SOFT_PUSHMETRICEXPORTER_MISS", "pushmetricexporter"},
		{"Configure pullmetricreaderr carefully.", "EN_SOFT_PULLMETRICREADER_MISS", "pullmetricreader"},
		{"Set metricexportresultt carefully.", "EN_SOFT_METRICEXPORTRESULT_MISS", "metricexportresult"},
		{"Set instrumentdescriptorr carefully.", "EN_SOFT_INSTRUMENTDESCRIPTOR_MISS", "instrumentdescriptor"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave169(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track enterprise arr carefully.", "EN_SOFT_PICKY_ENTERPRISE_ARR"},
		{"Track midmarket arr carefully.", "EN_SOFT_PICKY_MIDMARKET_ARR"},
		{"Track regional arr carefully.", "EN_SOFT_PICKY_REGIONAL_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeHerouiBitsuiMeltui(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with heroui carefully.",
		"Style with HeroUI carefully.",
		"Style with bitsui carefully.",
		"Style with BitsUI carefully.",
		"Style with meltui carefully.",
		"Style with MeltUI carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftIdiomConfusablesWave194(t *testing.T) {
	cases := []struct {
		text, rule, sug string
	}{
		{"Configure viewmatcherr carefully.", "EN_SOFT_VIEWMATCHER_MISS", "viewmatcher"},
		{"Configure instrumentselectorr carefully.", "EN_SOFT_INSTRUMENTSELECTOR_MISS", "instrumentselector"},
		{"Configure meterselectorr carefully.", "EN_SOFT_METERSELECTOR_MISS", "meterselector"},
		{"Configure attributeselectorr carefully.", "EN_SOFT_ATTRIBUTESELECTOR_MISS", "attributeselector"},
		{"Set instrumentnamee carefully.", "EN_SOFT_INSTRUMENTNAME_MISS", "instrumentname"},
		{"Set instrumentunitt carefully.", "EN_SOFT_INSTRUMENTUNIT_MISS", "instrumentunit"},
		{"Set instrumentdescriptionn carefully.", "EN_SOFT_INSTRUMENTDESCRIPTION_MISS", "instrumentdescription"},
		{"Set instrumentkindd carefully.", "EN_SOFT_INSTRUMENTKIND_MISS", "instrumentkind"},
		{"Set instrumenttypee carefully.", "EN_SOFT_INSTRUMENTTYPE_MISS", "instrumenttype"},
		{"Set valuetypee carefully.", "EN_SOFT_VALUETYPE_MISS", "valuetype"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_SoftPickyENJargonWave170(t *testing.T) {
	cases := []struct {
		text, rule string
	}{
		{"Track vertical arr carefully.", "EN_SOFT_PICKY_VERTICAL_ARR"},
		{"Track platform arr carefully.", "EN_SOFT_PICKY_PLATFORM_ARR"},
		{"Track territory arr carefully.", "EN_SOFT_PICKY_TERRITORY_ARR"},
	}
	for _, tc := range cases {
		t.Run(tc.rule, func(t *testing.T) {
			var buf bytes.Buffer
...
func TestGolden_ImmunizeCapsizeNuxtuiQuasar(t *testing.T) {
	if DiscoverEnglishSoftDisambiguationXML(nil) == "" {
		t.Skip("en-soft disambig missing")
	}
	for _, text := range []string{
		"Style with capsize carefully.",
		"Style with Capsize carefully.",
		"Style with nuxtui carefully.",
		"Style with NuxtUI carefully.",
		"Style with quasar carefully.",
		"Style with Quasar carefully.",
	} {
		t.Run(text, func(t *testing.T) {
			var buf bytes.Buffer
