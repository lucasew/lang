...
func TestGolden_MultiLangSoftGrammar(t *testing.T) {
	cases := []struct {
		...
		{"ar", "لا لا", "AR_SOFT_LA_LA"},
		{"be", "і і", "BE_SOFT_I_I"},
		{"be", "што што", "BE_SOFT_SHTO_SHTO"},
		{"br", "ha ha", "BR_SOFT_HA_HA"},
		{"br", "ne ne", "BR_SOFT_NE_NE"},
		{"eo", "kaj kaj", "EO_SOFT_KAJ_KAJ"},
		{"eo", "ke ke", "EO_SOFT_KE_KE"},
		{"fa", "و و", "FA_SOFT_VA_VA"},
		{"fa", "این این", "FA_SOFT_IN_IN"},
		{"ga", "agus agus", "GA_SOFT_AGUS_AGUS"},
		{"ga", "is is", "GA_SOFT_IS_IS"},
		{"is", "og og", "IS_SOFT_OG_OG"},
		{"is", "sem sem", "IS_SOFT_SEM_SEM"},
		{"ja", "to to", "JA_SOFT_TO_TO"},
		{"ja", "mo mo", "JA_SOFT_MO_MO"},
		{"km", "and and", "KM_SOFT_AND_AND"},
		{"km", "for for", "KM_SOFT_FOR_FOR"},
		{"lt", "ir ir", "LT_SOFT_IR_IR"},
		{"lt", "kad kad", "LT_SOFT_IR_KAD"},
		{"ml", "um um", "ML_SOFT_UM_UM"},
		{"ml", "for for", "ML_SOFT_FOR_FOR"},
		{"sl", "in in", "SL_SOFT_IN_IN"},
		{"sl", "da da", "SL_SOFT_DA_DA"},
		{"sr", "i i", "SR_SOFT_I_I"},
		{"sr", "to to", "SR_SOFT_I_TO"},
		{"ta", "um um", "TA_SOFT_UM_UM"},
		{"ta", "for for", "TA_SOFT_FOR_FOR"},
		{"tl", "at at", "TL_SOFT_AT_AT"},
		{"tl", "hindi hindi", "TL_SOFT_HINDI_HINDI"},
		{"zh", "的 的", "ZH_SOFT_DE_DE"},
		{"zh", "我 我", "ZH_SOFT_WO_WO"},
		{"ast", "y y", "AST_SOFT_Y_Y"},
		{"ast", "que que", "AST_SOFT_QUE_QUE"},
		{"crh", "ve ve", "CRH_SOFT_VE_VE"},
		{"crh", "bu bu", "CRH_SOFT_VE_BU"},
	}
...
func TestGolden_MultiLangSoftGrammarExtra(t *testing.T) {
	cases := []struct {
		...
		{"fr", "Il est venu malgré que ce soit tard.", "FR_SOFT_MALGRE_QUE", ""},
		{"fr", "Comme même, j'y vais.", "FR_SOFT_COMME_MEME", "Quand même"},
		{"fr", "Tout a part lui.", "FR_SOFT_A_PART", "à part"},
		{"fr", "Cest simple.", "FR_SOFT_CEST_SA", "C'est"},
		{"fr", "Je préfère plutot attendre.", "FR_SOFT_PLUTOT_QUE", "plutôt"},
		...
		{"es", "He echo la tarea.", "ES_SOFT_ECHO_HECHO", "He hecho"},
		{"es", "Valla usted con cuidado.", "ES_SOFT_VALLA_VAYA", "Vaya usted"},
		{"es", "Espero que aya visto esto.", "ES_SOFT_AYA_HAYA", "haya visto"},
		{"es", "Ha echo la tarea.", "ES_SOFT_HA_ECHO", "Ha hecho"},
		{"es", "Tubo que salir.", "ES_SOFT_TUVO_TUBO", "Tuvo que"},
		{"es", "Espero que halla visto esto.", "ES_SOFT_HALLA_HAYA", "haya visto"},
		...
		{"it", "Qualche uno ha chiamato.", "IT_SOFT_QUALCHE_UNO", "qualcuno"},
		{"it", "Vado a la scuola.", "IT_SOFT_A_LA", "alla"},
		{"it", "Libro di la ragazza.", "IT_SOFT_DI_LA", "della"},
		{"it", "Sono in la casa.", "IT_SOFT_IN_LA", "nella"},
		{"it", "Poiche piove, resto.", "IT_SOFT_POICHE", "Poiché"},
		{"it", "Qualche cosa manca.", "IT_SOFT_QUALCHE_COSA", "qualcosa"},
		{"it", "Ma ma non so.", "IT_SOFT_MA_MA", ""},
		...
		{"pt", "Passou por a rua.", "PT_SOFT_POR_A", "pela"},
		{"pt", "Mas mas eu fui.", "PT_SOFT_MAS_MAS", ""},
		{"pt", "Não não quero.", "PT_SOFT_NAO_NAO", ""},
		{"pt", "Foi a muito tempo.", "PT_SOFT_HA_A", "há muito tempo"},
		{"pt", "Mais eu não quero.", "PT_SOFT_MAIS_MAS", "Mas eu não"},
		{"pt", "Aonde você está agora?", "PT_SOFT_ONDE_AONDE", ""},
		{"pt", "Livro de de autor.", "PT_SOFT_DE_DE", ""},
		...
		{"nl", "Hun zijn klaar.", "NL_SOFT_HUN_ZIJN", ""},
		{"nl", "Hij word groot.", "NL_SOFT_WORD_WORDT", "Hij wordt"},
		...
		{"nl", "Dat is niet niet waar.", "NL_SOFT_NIET_NIET", ""},
		{"nl", "Goed!!", "NL_SOFT_DOUBLE_BANG", "!"},
		{"da", "Dem er her.", "DA_SOFT_DEM_ER", "De er"},
		{"da", "Han er mindre som mig.", "DA_SOFT_MINDRE_SOM", "mindre end"},
		{"da", "Fordi fordi det regner.", "DA_SOFT_FORDI_FORDI", ""},
		{"da", "Jeg håber at at det går.", "DA_SOFT_AT_AT", ""},
		{"pl", "Chcę żeby żeby przyszedł.", "PL_SOFT_ZEBY_ZEBY", ""},
		{"pl", "Już już wiem.", "PL_SOFT_JUZ_JUZ", ""},
		// second-wave packs
		...
		{"sv", "Dom vill hem.", "SV_SOFT_DOM_VILL", "De vill"},
		{"sv", "Han är mindre som mig.", "SV_SOFT_MINDRE_SOM", "mindre än"},
		{"sv", "Det är inte inte sant.", "SV_SOFT_INTE_INTE", ""},
		{"sv", "Jag hoppas att att det går.", "SV_SOFT_ATT_ATT", ""},
		{"sv", "Eftersom att det regnar.", "SV_SOFT_EFTERSOM_ATT", ""},
		{"sv", "Hej!!", "SV_SOFT_DOUBLE_BANG", "!"},
		{"fr", "Peutetre demain.", "FR_SOFT_PEUTETRE", "Peut-être"},
		{"fr", "Aujourdui je reste.", "FR_SOFT_AUJOURDUI", "Aujourd'hui"},
		{"fr", "Quelque un a appelé.", "FR_SOFT_QUELQUE_UN", "quelqu'un"},
		{"fr", "Quelque choses manquent.", "FR_SOFT_QUELQUE_CHOSE", "Quelque chose"},
		{"fr", "Sa va bien.", "FR_SOFT_SA_CA", "ça va"},
		{"ru", "Что что случилось.", "RU_SOFT_CHTO_CHTO", ""},
		{"ru", "Как как это.", "RU_SOFT_KAK_KAK", ""},
		{"ru", "Из за дождя.", "RU_SOFT_IZA_IZ", ""},
		{"ru", "Вообщем, ладно.", "RU_SOFT_VOOBSHE", ""},
		{"uk", "Що що сталося.", "UK_SOFT_SHCHO_SHCHO", ""},
		{"uk", "Як як це.", "UK_SOFT_YAK_YAK", ""},
		{"uk", "Вобщем, добре.", "UK_SOFT_VZAGALI", ""},
		{"ca", "Perque plou.", "CA_SOFT_PERQUE", "Perquè"},
		{"ca", "Tambe vull anar.", "CA_SOFT_TAMBE", "També"},
		{"ca", "No no vull.", "CA_SOFT_NO_NO", ""},
		{"gl", "Estou en a casa.", "GL_SOFT_EM_A", "na"},
		{"gl", "Estou en o coche.", "GL_SOFT_EM_O", "no"},
		{"gl", "Pasou por a rúa.", "GL_SOFT_POR_A", "pola"},
		{"gl", "Non non quero.", "GL_SOFT_NON_NON", ""},
		{"ro", "Nu nu vreau.", "RO_SOFT_NU_NU", ""},
		{"ro", "Zic că că vine.", "RO_SOFT_CA_CA", ""},
		{"ro", "Intru dintr o casă.", "RO_SOFT_DINTR_O", ""},
		{"el", "Που που είσαι.", "EL_SOFT_POU_POU", ""},
		{"el", "Θα θα έρθω.", "EL_SOFT_THA_THA", ""},
		{"sk", "Aby aby prišiel.", "SK_SOFT_ABY_ABY", ""},
		{"sk", "Už už viem.", "SK_SOFT_UZ_UZ", ""},
