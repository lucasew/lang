...
func TestWikipediaTextFilter_ImageRemoval(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testImageRemoval")
}
...
func TestWikipediaTextFilter_RemovalOfImageWithLink(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testRemovalOfImageWithLink")
}
...
func TestWikipediaTextFilter_Link1(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testLink1")
}
...
func TestWikipediaTextFilter_Link2(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testLink2")
}
...
func TestWikipediaTextFilter_Entity(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testEntity")
}
...
func TestWikipediaTextFilter_Lists(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testLists")
}
...
func TestWikipediaTextFilter_OtherStuff(t *testing.T) {
	tools.Unimplemented("WikipediaTextFilterTest.testOtherStuff")
}
