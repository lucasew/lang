...
const EsperantoDictPath = "/eo/eo.dict"

type EsperantoTagger struct { *tagging.BaseTagger }

func NewEsperantoTagger(wt tagging.WordTagger) *EsperantoTagger {
	return &EsperantoTagger{BaseTagger: tagging.NewBaseTagger(wt, EsperantoDictPath, "eo", false)}
}
