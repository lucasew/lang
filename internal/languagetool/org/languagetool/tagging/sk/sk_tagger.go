...
const SlovakDictPath = "/sk/sk.dict"

type SlovakTagger struct { *tagging.BaseTagger }

func NewSlovakTagger(wt tagging.WordTagger) *SlovakTagger {
	return &SlovakTagger{BaseTagger: tagging.NewBaseTagger(wt, SlovakDictPath, "sk", false)}
}
