...
const DanishDictPath = "/da/da.dict"

type DanishTagger struct { *tagging.BaseTagger }

func NewDanishTagger(wt tagging.WordTagger) *DanishTagger {
	return &DanishTagger{BaseTagger: tagging.NewBaseTagger(wt, DanishDictPath, "da", false)}
}
