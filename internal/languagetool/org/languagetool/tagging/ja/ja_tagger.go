...
type JapaneseTagger struct { *tagging.BaseTagger }

func NewJapaneseTagger(wt tagging.WordTagger) *JapaneseTagger {
	return &JapaneseTagger{BaseTagger: tagging.NewBaseTagger(wt, JapaneseDictPath, "ja", false)}
}
