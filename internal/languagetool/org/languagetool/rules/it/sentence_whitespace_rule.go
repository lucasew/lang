...
func NewSentenceWhitespaceRule(messages map[string]string) *SentenceWhitespaceRule {
	...
	base.RuleID = "IT_SENTENCE_WHITESPACE"
	base.MessageAfterSentence = "Aggiungi uno spazio tra le frasi."
	base.MessageAfterNumber = "Aggiungi uno spazio dopo i numeri ordinali."
