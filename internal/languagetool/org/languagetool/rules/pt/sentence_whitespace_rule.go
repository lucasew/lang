...
func NewSentenceWhitespaceRule(messages map[string]string) *SentenceWhitespaceRule {
	...
	base.RuleID = "PT_SENTENCE_WHITESPACE"
	base.MessageAfterSentence = "Adicione um espaço entre frases."
	base.MessageAfterNumber = "Adicione um espaço após números ordinais."
