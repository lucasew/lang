...
// PortugueseSuppressMisspelledSuggestionsFilter ports
...
// Default IsMisspelled is FilterDictIsMisspelled (false when no WirePortugueseFilterSpeller).
...
func (f *PortugueseSuppressMisspelledSuggestionsFilter) SetIsMisspelled(fn func(string) bool) {
...
func (f *PortugueseSuppressMisspelledSuggestionsFilter) FilterSuggestions(suggs []string, suppressMatch bool) (kept []string, keepMatch bool) {
...
func (f *PortugueseSuppressMisspelledSuggestionsFilter) AcceptRuleMatch(match *rules.RuleMatch, arguments map[string]string, _ int,
