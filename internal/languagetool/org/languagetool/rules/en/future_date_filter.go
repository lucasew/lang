...
// FutureDateFilter ports org.languagetool.rules.en.FutureDateFilter
// (extends AbstractFutureDateFilter with EN month localization).
...
// ParseDayOfMonth extracts leading digits from strings like "23rd" / "23".
